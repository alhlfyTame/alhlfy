...
if plugin and plugin.Thealhlfy and msg then
results = plugin.Thealhlfy(msg)
end
end
...
if data.actor_user_id == UserCheck and tonumber(Thealhlfy) ~= UserCheck then
local Get_Chat = bot.getChat(data.chat_id)
local Info_Chats = bot.getSupergroupFullInfo(data.chat_id)
local UserInfo = bot.getUser(data.actor_user_id)
...
if not Redis:get(Thealhlfy.."gdbye"..data.chat_id) then
if data.actor_user_id == UserCheck and tonumber(Thealhlfy) ~= UserCheck then
local Get_Chat = bot.getChat(data.chat_id)
local Info_Chats = bot.getSupergroupFullInfo(data.chat_id)
local UserInfo = bot.getUser(data.actor_user_id)
...
if data.new_chat_member.member_id.user_id == tonumber(Thealhlfy) or data.old_chat_member.member_id.user_id == tonumber(Thealhlfy) then
...
--code start
if Redis:sismember(Thealhlfy..'Black:listBan:',chat_id) then ---check if ban
...
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(Thealhlfy..'alhlfy:Num:Add:Bot') or 0)) then
send(chat_id,0,'• عدد الاعضاء قليل لا يمكن تفعيل القروب\n يجب ان يكون اكثر من '..Redis:get(Thealhlfy..'alhlfy:Num:Add:Bot'),"md",true)
bot.leaveChat(chat_id)
end---end check if count is true
if not Redis:get(Thealhlfy.."alhlfy:BotFree") then
return send(chat_id,0,"\n⇜ الوضع الخدمي تم تعطيله من قبل مطور البوت ","md",true)  
end
if not Redis:sismember(Thealhlfy.."alhlfy:ChekBotAdd", chat_id) then ---done active
...
-----
Redis:set(Thealhlfy.."alhlfy:Alzwag:Chat"..chat_id,"true")
Redis:set(Thealhlfy.."alhlfy:Aldel:Chat"..chat_id,"true")
Redis:set(Thealhlfy.."NSFW:"..chat_id,"true")
Redis:set(Thealhlfy..'tagallgroup'..chat_id,'open') 
Redis:set(Thealhlfy.."alhlfy:Status:Link"..chat_id,true) 
Redis:set(Thealhlfy.."alhlfy:Status:Games"..chat_id,true) 
Redis:set(Thealhlfy.."replayallbot"..chat_id,true)
Redis:set(Thealhlfy.."rebomsg"..chat_id,true)
Redis:set(Thealhlfy.."alhlfy:AlThther:Chat"..chat_id,"true")
Redis:set(Thealhlfy.."alhlfy:Status:Welcome"..chat_id,true) 
Redis:set(Thealhlfy.."alhlfy:AlThther:Chat"..chat_id,"true")
Redis:set(Thealhlfy..'tagall@all'..chat_id,'open') 
Redis:set(Thealhlfy.."alhlfy:Status:IdPhoto"..chat_id,true) 
Redis:del(Thealhlfy.."spammkick"..chat_id)
Redis:set(Thealhlfy.."alhlfy:Lock:edit"..chat_id,true) 
Redis:sadd(Thealhlfy.."alhlfy:ChekBotAdd",chat_id)
Redis:set(Thealhlfy.."alhlfy:Status:Id"..chat_id,true)
Redis:set(Thealhlfy.."alhlfy:Status:Reply"..chat_id,true)
Redis:set(Thealhlfy.."alhlfy:Status:ReplySudo"..chat_id,true)
Redis:set(Thealhlfy.."alhlfy:Status:BanId"..chat_id,true)
Redis:set(Thealhlfy.."alhlfy:Status:SetId"..chat_id,true) 
-----
...
Redis:sadd(Thealhlfy.."alhlfy:TheBasicsQ:Group"..chat_id ,v.member_id.user_id) 
else
Redis:sadd(Thealhlfy.."alhlfy:Addictive:Group"..chat_id ,v.member_id.user_id) 
end
end
end
-----
...
local inget = Redis:get(Thealhlfy..'hmsabots'..ramsesadd[3]..data.sender_user_id)
...
Redis:set(Thealhlfy..'hmsabots'..idnum..UserId_Info.id,username[1])
Redis:set(Thealhlfy..'hmsabots'..idnum..data.sender_user_id,username[1])
end
end
end
...
Redis:srem(Thealhlfy.."alhlfy:ChekBotAdd",'-100'..data.supergroup.id)
...
Redis:sadd(Thealhlfy.."alhlfy:all:sticker"..msg.chat_id, msg.id)
Redis:scard(Thealhlfy.."alhlfy:all:sticker"..msg.chat_id)  
end
if msg.content.video_note or msg.content.video then
Redis:sadd(Thealhlfy.."alhlfy:all:video"..msg.chat_id, msg.id)
Redis:scard(Thealhlfy.."alhlfy:all:video"..msg.chat_id)  
end
if msg.content.document then
Redis:sadd(Thealhlfy.."alhlfy:all:docu"..msg.chat_id, msg.id)
Redis:scard(Thealhlfy.."alhlfy:all:docu"..msg.chat_id)  
end
if msg.content.audio then
Redis:sadd(Thealhlfy.."alhlfy:all:audio"..msg.chat_id, msg.id)
Redis:scard(Thealhlfy.."alhlfy:all:audio"..msg.chat_id)  
end
if msg.content.voice_note then
Redis:sadd(Thealhlfy.."alhlfy:all:voice"..msg.chat_id, msg.id)
Redis:scard(Thealhlfy.."alhlfy:all:voice"..msg.chat_id)  
end
if msg.content.photo then
Redis:sadd(Thealhlfy.."alhlfy:all:photo"..msg.chat_id, msg.id)
Redis:scard(Thealhlfy.."alhlfy:all:photo"..msg.chat_id)  
end
if msg.content.animation then
Redis:sadd(Thealhlfy.."alhlfy:all:anim"..msg.chat_id, msg.id)
Redis:scard(Thealhlfy.."alhlfy:all:anim"..msg.chat_id)  
end
if msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
Redis:sadd(Thealhlfy.."alhlfy:allM"..msg.chat_id, msg.id)
if Redis:get(Thealhlfy.."alhlfy:Status:Del:Media"..msg.chat_id) then    
local Numbardel = Redis:get(Thealhlfy.."alhlfy:allM:numdel"..msg.chat_id) or 200
local gmedia = Redis:scard(Thealhlfy.."alhlfy:allM"..msg.chat_id)  
if tonumber(gmedia) >= tonumber(Numbardel) then
local liste = Redis:smembers(Thealhlfy.."alhlfy:allM"..msg.chat_id)
...
Redis:del(Thealhlfy.."alhlfy:allM"..msg.chat_id)
end
end
end
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(Thealhlfy.."alhlfy:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Thealhlfy.."alhlfy:PinMsegees:"..msg.chat_id)
end
...
if idPhoto == Redis:get(Thealhlfy.."alhlfy:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Thealhlfy.."alhlfy:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(Thealhlfy.."alhlfy:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Thealhlfy.."alhlfy:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(Thealhlfy.."alhlfy:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Thealhlfy.."alhlfy:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(Thealhlfy.."alhlfy:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Thealhlfy.."alhlfy:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(Thealhlfy.."alhlfy:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Thealhlfy.."alhlfy:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(Thealhlfy.."alhlfy:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Thealhlfy.."alhlfy:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(Thealhlfy.."alhlfy:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Thealhlfy.."alhlfy:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(Thealhlfy.."alhlfy:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Thealhlfy.."alhlfy:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(Thealhlfy.."alhlfy:Lock:tagservr"..data.message.chat_id) then
bot.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender_user_id) == tonumber(Thealhlfy) then
return false
end
if chat_type(data.message.chat_id) == "GroupBot" and Redis:sismember(Thealhlfy.."alhlfy:ChekBotAdd",data.message.chat_id) then
 msg = data.message
...
if tonumber(msg.sender_id.user_id) == tonumber(Thealhlfy) then
print('This is reply for Bot')
return false
end
if msg.sender_id.luatele == "messageSenderChat" then
if Redis:sismember(Thealhlfy.."alhlfy:SilentGroup:Group"..msg_chat_id,msg.sender_id.chat_id) then
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
end
if Redis:get(Thealhlfy.."alhlfy:Lock:SenderChat"..msg_chat_id) then
local m = Redis:get(Thealhlfy.."chadmin"..msg_chat_id) 
...
elseif Redis:sismember(Thealhlfy.."alhlfy:DevelopersQ:Groups",msg.sender_id.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'Myth🎖️️'
elseif Redis:sismember(Thealhlfy.."alhlfy:Developers:Groups",msg.sender_id.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(Thealhlfy..'alhlfy:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Thealhlfy.."alhlfy:Developer:Bot:Reply"..msg.chat_id) or 'Myth'
elseif Redis:sismember(Thealhlfy.."alhlfy:MalekAsase:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 444
msg.Name_Controller = Redis:get(Thealhlfy..'alhlfy:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Thealhlfy.."alhlfy:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(Thealhlfy.."alhlfy:TheBasicsQ:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(Thealhlfy..'alhlfy:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Thealhlfy.."alhlfy:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(Thealhlfy.."alhlfy:TheBasics:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(Thealhlfy..'alhlfy:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Thealhlfy.."alhlfy:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(Thealhlfy.."alhlfy:Originators:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(Thealhlfy..'alhlfy:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Thealhlfy.."alhlfy:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ'
elseif Redis:sismember(Thealhlfy.."alhlfy:Managers:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(Thealhlfy..'alhlfy:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Thealhlfy.."alhlfy:Manager:Group:Reply"..msg.chat_id) or 'المدير'
elseif Redis:sismember(Thealhlfy.."alhlfy:Addictive:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(Thealhlfy..'alhlfy:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Thealhlfy.."alhlfy:Admin:Group:Reply"..msg.chat_id) or 'الادمن'
elseif Redis:sismember(Thealhlfy.."alhlfy:Distinguished:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(Thealhlfy..'alhlfy:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Thealhlfy.."alhlfy:Vip:Group:Reply"..msg.chat_id) or 'مميز'
elseif tonumber(msg.sender_id.user_id) == tonumber(Thealhlfy) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(Thealhlfy..'alhlfy:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Thealhlfy.."alhlfy:Mempar:Group:Reply"..msg.chat_id) or 'عضو'
end  
...
if Message_Edit.sender_id.user_id == Thealhlfy then
...
data.The_Controller = 1
elseif Redis:sismember(Thealhlfy.."alhlfy:DevelopersQ:Groups",Message_Edit.sender_id.user_id) == true then
data.The_Controller = 2
elseif Redis:sismember(Thealhlfy.."alhlfy:Developers:Groups",Message_Edit.sender_id.user_id) == true then
data.The_Controller = 3
elseif Redis:sismember(Thealhlfy.."alhlfy:TheBasicsQ:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 44
elseif Redis:sismember(Thealhlfy.."alhlfy:TheBasics:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 4
elseif Redis:sismember(Thealhlfy.."alhlfy:Originators:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 5
elseif Redis:sismember(Thealhlfy.."alhlfy:Managers:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 6
elseif Redis:sismember(Thealhlfy.."alhlfy:Addictive:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 7
elseif Redis:sismember(Thealhlfy.."alhlfy:Distinguished:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 8
elseif tonumber(Message_Edit.sender_id.user_id) == tonumber(Thealhlfy) then
...
local monsha = Redis:smembers(Thealhlfy.."alhlfy:TheBasicsQ:Group"..data.chat_id) 
Redis:incr(Thealhlfy..'alhlfy:Num:Message:Edit'..data.chat_id..Message_Edit.sender_id.user_id)
if Message_Edit.content.luatele == "messageText" then
if Redis:get(Thealhlfy.."alhlfy:Lock:edittext"..data.chat_id) then
if not data.Distinguished then
bot.deleteMessages(data.chat_id,{[1]= data.message_id})
if Redis:get(Thealhlfy..'alhlfy:AlThther:Chat'..data.chat_id)  then
local UserInfo = bot.getUser(Message_Edit.sender_id.user_id)
...
if not data.Originators and Message_Edit.sender_id.user_id ~= tonumber(Thealhlfy) then
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(Thealhlfy.."alhlfy:Lock:edit"..data.chat_id) then
if #monsha ~= 0 then 
...
data.The_Controller = 1
elseif Redis:sismember(Thealhlfy.."alhlfy:DevelopersQ:Groups",IdUser) == true then
data.The_Controller = 2
elseif Redis:sismember(Thealhlfy.."alhlfy:Developers:Groups",IdUser) == true then
data.The_Controller = 3
elseif Redis:sismember(Thealhlfy.."alhlfy:TheBasicsQ:Group"..ChatId,IdUser) == true then
data.The_Controller = 44
elseif Redis:sismember(Thealhlfy.."alhlfy:TheBasics:Group"..ChatId,IdUser) == true then
data.The_Controller = 4
elseif Redis:sismember(Thealhlfy.."alhlfy:Originators:Group"..ChatId,IdUser) == true then
data.The_Controller = 5
elseif Redis:sismember(Thealhlfy.."alhlfy:Managers:Group"..ChatId,IdUser) == true then
data.The_Controller = 6
elseif Redis:sismember(Thealhlfy.."alhlfy:Addictive:Group"..ChatId,IdUser) == true then
data.The_Controller = 7
elseif Redis:sismember(Thealhlfy.."alhlfy:Distinguished:Group"..ChatId,IdUser) == true then
data.The_Controller = 8
elseif tonumber(IdUser) == tonumber(Thealhlfy) then
data.The_Controller = 9
else
data.The_Controller = 10
end  
...
local get = Redis:get(Thealhlfy..IdUser..ChatId.."num")
if get then
tf = get 
else
tf = "" 
...
local txx = tf..num
Redis:set(Thealhlfy..IdUser..ChatId.."num",txx)
...
if tonumber(IdUser) == tonumber(sendrr) then
local math = Redis:get(Thealhlfy..IdUser..ChatId.."num")
if math then
...
Redis:del(Thealhlfy..IdUser..ChatId.."num")
else
bot.answerCallbackQuery(data.id, "• الامر لا يخصك", true)
end
end
...
Redis:set(Thealhlfy..IdUser..ChatId.."num",gxx)
...
local chat_id = Redis:get(Thealhlfy.."hms:"..anubis[2].."chat_id")
local to_id = Redis:get(Thealhlfy.."hms:"..anubis[2].."to")
local msg_id = Redis:get(Thealhlfy.."hms:"..anubis[2].."msg_id")
...
Redis:del(Thealhlfy.."hms:"..anubis[1])
end
end
if Text and Text:match('(.*)hms_no(.*)') then
local anubis = {Text:match('(.*)hms_no(.*)')}
if tonumber(IdUser) == tonumber(anubis[1]) then
Redis:del(Thealhlfy.."hms:"..anubis[2].."chat_id")
Redis:del(Thealhlfy.."hms:"..anubis[2].."to")
Redis:del(Thealhlfy.."hms:"..anubis[2].."msg_id")
Redis:del(Thealhlfy.."hms:"..anubis[1])
...
local hmsa = Redis:get(Thealhlfy.."hms:"..anubis[3].."text:")
...
var(UserId)
Redis:set(Thealhlfy.."zogte"..ChatId..UserId[1],UserId[2])
Redis:set(Thealhlfy.."zogte"..ChatId..UserId[2],UserId[1])
Redis:sadd(Thealhlfy.."zogatall"..ChatId,UserId[1])
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:del(Thealhlfy.."zogte"..ChatId..UserId[1])
Redis:del(Thealhlfy.."zogte"..ChatId..UserId[2])
Redis:srem(Thealhlfy.."zogatall"..ChatId,UserId[1])
local UserInfo = bot.getUser(UserId[1])
...
Redis:srem(Thealhlfy.."alhlfy:Distinguished:Group"..ChatId,IdUser)
Redis:srem(Thealhlfy.."alhlfy:Addictive:Group"..ChatId,IdUser)
Redis:srem(Thealhlfy.."alhlfy:Managers:Group"..ChatId,IdUser)
Redis:srem(Thealhlfy.."alhlfy:Originators:Group"..ChatId,IdUser)
Redis:srem(Thealhlfy.."alhlfy:TheBasics:Group"..ChatId,IdUser)
Redis:srem(Thealhlfy.."alhlfy:Developers:Groups",IdUser) 
Redis:srem(Thealhlfy.."alhlfy:TheBasicsQ:Group"..ChatId,IdUser)
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Thealhlfy.."alhlfy:TheBasics:Group"..ChatId,UserId[2]) then
Redis:srem(Thealhlfy.."alhlfy:TheBasics:Group"..ChatId,UserId[2])
else
Redis:sadd(Thealhlfy.."alhlfy:TheBasics:Group"..ChatId,UserId[2])
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then 
if Redis:sismember(Thealhlfy.."alhlfy:Originators:Group"..ChatId,UserId[2]) then
Redis:srem(Thealhlfy.."alhlfy:Originators:Group"..ChatId,UserId[2])
else
Redis:sadd(Thealhlfy.."alhlfy:Originators:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Thealhlfy.."alhlfy:Managers:Group"..ChatId,UserId[2]) then
Redis:srem(Thealhlfy.."alhlfy:Managers:Group"..ChatId,UserId[2])
else
if not data.Originators and not Redis:get(Thealhlfy.."alhlfy:Status:SetId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ تم تعطيل ( الرفع ) من قبل المنشئين",true)
end 
Redis:sadd(Thealhlfy.."alhlfy:Managers:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Thealhlfy.."alhlfy:Addictive:Group"..ChatId,UserId[2]) then
Redis:srem(Thealhlfy.."alhlfy:Addictive:Group"..ChatId,UserId[2])
else
if not data.Originators and not Redis:get(Thealhlfy.."alhlfy:Status:SetId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ تم تعطيل ( الرفع ) من قبل المنشئين",true)
end 
Redis:sadd(Thealhlfy.."alhlfy:Addictive:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Thealhlfy.."alhlfy:Distinguished:Group"..ChatId,UserId[2]) then
Redis:srem(Thealhlfy.."alhlfy:Distinguished:Group"..ChatId,UserId[2])
else
if not data.Originators and not Redis:get(Thealhlfy.."alhlfy:Status:SetId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ تم تعطيل ( الرفع ) من قبل المنشئين",true)
end 
Redis:sadd(Thealhlfy.."alhlfy:Distinguished:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:srem(Thealhlfy.."alhlfy:Originators:Group"..ChatId,UserId[2])
Redis:srem(Thealhlfy.."alhlfy:TheBasics:Group"..ChatId,UserId[2])
Redis:srem(Thealhlfy.."alhlfy:SilentGroup:Group"..ChatId,UserId[2])
Redis:srem(Thealhlfy.."alhlfy:BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(Thealhlfy.."alhlfy:BanGroup:Group"..ChatId,UserId[2]) then
Redis:srem(Thealhlfy.."alhlfy:BanGroup:Group"..ChatId,UserId[2])
bot.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
else
if not data.Originators and not Redis:get(Thealhlfy.."alhlfy:Status:BanId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ ( الحظر - الطرد - التقييد ) معطل من قبل المنشئين",true)
end 
Redis:sadd(Thealhlfy.."alhlfy:BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(Thealhlfy.."alhlfy:SilentGroup:Group"..ChatId,UserId[2]) then
Redis:srem(Thealhlfy.."alhlfy:SilentGroup:Group"..ChatId,UserId[2])
else
if not data.Originators and not Redis:get(Thealhlfy.."alhlfy:Status:BanId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ ( الحظر - الطرد - التقييد ) معطل من قبل المنشئين",true)
end 
Redis:sadd(Thealhlfy.."alhlfy:SilentGroup:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
if Text and Text:match('/keyhzr') then
local list = Redis:smembers(Thealhlfy..'List_hzr'..ChatId) 
nameko = list[#list]
playerhzr = Redis:get(Thealhlfy..'playerhzr'..ChatId)
klmahzr = Redis:get(Thealhlfy..'klmahzr'..ChatId)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Command:Reids:Group:Del"..ChatId..":"..IdUser)
Redis:del(Thealhlfy.."alhlfy:Command:Reids:Group"..ChatId..":"..IdUser)
Redis:del(Thealhlfy.."alhlfy:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(Thealhlfy.."alhlfy:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(Thealhlfy.."alhlfy:Set:Rd"..IdUser..":"..ChatId)
Redis:del(Thealhlfy.."alhlfy:Set:On"..IdUser..":"..ChatId)
Redis:del(Thealhlfy.."Set:array:Ssd"..IdUser..":"..ChatId)
Redis:del(Thealhlfy.."Set:array:rd"..IdUser..":"..ChatId)
Redis:del(Thealhlfy.."Set:array"..IdUser..":"..ChatId)
Redis:del(Thealhlfy.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(Thealhlfy.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(Thealhlfy.."Set:Rd"..IdUser..":"..ChatId)
Redis:del(Thealhlfy.."Set:On"..IdUser..":"..ChatId)
Redis:del(Thealhlfy.."Set:Manager:rd:inline"..IdUser..":"..ChatId)
Redis:del(Thealhlfy.."Set:On:mz"..IdUser..":"..ChatId)
Redis:del(Thealhlfy.."Set:Rd:mz"..IdUser..":"..ChatId)
Redis:del(Thealhlfy.."Set:Onmzch"..IdUser..":"..ChatId)
Redis:del(Thealhlfy.."Set:Rdmzch"..IdUser..":"..ChatId)
Redis:del(Thealhlfy.."Set:Manager:rd:inline3am"..IdUser..":"..ChatId)
...
if Redis:get(Thealhlfy..'Set:arrayy'..IdUser..':'..ChatId) == 'true1' then
Redis:del(Thealhlfy..'Set:arrayy'..IdUser..':'..ChatId)
...
if Redis:get(Thealhlfy..'Set:array'..IdUser..':'..ChatId) == 'true1' then
Redis:del(Thealhlfy..'Set:array'..IdUser..':'..ChatId)
edit(ChatId,Msg_id,"⇜ تم حفظ الردود ", 'md', true, false, reply_markup)
else
edit(ChatId,Msg_id,"⇜ تم تنفيذ الامر سابقاًً", 'md', true, false, reply_markup)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."trfeh"..ChatId)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."spammkick"..ChatId)
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."kadmeat"..ChatId)
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."knele"..ChatId)
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."brjj"..ChatId)
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy..'lock_geamsAudio1'..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy..'lock_geamsAudio'..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy..'tagall@all'..ChatId,'open')
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy..'lock_chengname'..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."trfeh"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."spammkick"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."kadmeat"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."knele"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."brjj"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy..'lock_geamsAudio1'..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy..'lock_geamsAudio'..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy..'tagall@all'..ChatId,'close')
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy..'lock_chengname'..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..ChatId..IdUser,3)  
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(Thealhlfy.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(Thealhlfy.."meza:type"..meza_name, "photo")
Redis:sadd(Thealhlfy.."meza:names:", meza_name)
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(Thealhlfy.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(Thealhlfy.."meza:type"..meza_name, "video")
Redis:sadd(Thealhlfy.."meza:names:", meza_name)
return edit(ChatId, Msg_id, "⇜ تم حفظ الميزة","md",false)
end end
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(Thealhlfy.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(Thealhlfy.."meza:type"..meza_name, "audio")
Redis:sadd(Thealhlfy.."meza:names:", meza_name)
return edit(ChatId, Msg_id, "⇜ تم حفظ الميزة","md",false)
end end
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(Thealhlfy.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(Thealhlfy.."meza:type"..meza_name, "animation")
Redis:sadd(Thealhlfy.."meza:names:", meza_name)
return edit(ChatId, Msg_id, "⇜ تم حفظ الميزة","md",false)
end end
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(Thealhlfy.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(Thealhlfy.."meza:type"..meza_name, "sticker")
Redis:sadd(Thealhlfy.."meza:names:", meza_name)
return edit(ChatId, Msg_id, "⇜ تم حفظ الميزة","md",false)
end end
if Text == '/joineloceagin' then
local list = Redis:smembers(Thealhlfy..'loce:list'..ChatId) 
...
Redis:set(Thealhlfy..'loce:listset1'..ChatId,xxffxx1)
Redis:srem(Thealhlfy..'loce:list'..ChatId,name1)
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..ChatId..name1,3)  
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local get1 = Redis:get(Thealhlfy..'loce:listset'..ChatId)
local get2 = Redis:get(Thealhlfy..'loce:listset1'..ChatId)

Redis:del(Thealhlfy..'loce:list'..ChatId) 
Redis:del(Thealhlfy..'loce:listset'..ChatId)
Redis:del(Thealhlfy..'loce:listset1'..ChatId)
return edit(ChatId,Msg_id,get1..'\n'..get2..'\n'..xxffxx1..'\n', 'md', true)
end
if Text == '/joineloce' then
if not Redis:sismember(Thealhlfy..'loce:list'..ChatId,IdUser) then 
Redis:sadd(Thealhlfy..'loce:list'..ChatId,IdUser)
local list = Redis:smembers(Thealhlfy..'loce:list'..ChatId) 
if #list == 3 then
name1 = list[math.random(#list)]
local UserInfo1 = bot.getUser(name1)
...
Redis:set(Thealhlfy..'loce:listset'..ChatId,xxffxx1)
Redis:srem(Thealhlfy..'loce:list'..ChatId,name1)
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..ChatId..name1,5)  
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local list = Redis:smembers(Thealhlfy..'rolet:list'..ChatId)
name = list[math.random(#list)]
local UserInfo = bot.getUser(name)
local Teext = '- ['..UserInfo.first_name..'](tg://user?id='..name..')'
Redis:srem(Thealhlfy..'rolet:list'..ChatId,name)
if #list == 1 then
Redis:srem(Thealhlfy..'rolet:list'..ChatId,name)
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..ChatId..IdUser,10)  
...
if not Redis:sismember(Thealhlfy..'rolet:list'..ChatId,IdUser) then 
Redis:sadd(Thealhlfy..'rolet:list'..ChatId,IdUser)
local list = Redis:smembers(Thealhlfy..'rolet:list'..ChatId) 
if #list == 3 then
...
Redis:sadd(Thealhlfy.."alhlfy:SilentGroup:Group"..ChatId,GetUserReply[1]) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local UserInfo = bot.getUser(GetUserReply[1])
local Teext = ' ['..UserInfo.first_name..'](tg://user?id='..GetUserReply[1]..')'
Redis:sadd(Thealhlfy.."alhlfy:BanGroup:Group"..ChatId,GetUserReply[1]) 
...
Redis:srem(Thealhlfy.."alhlfy:Distinguished:Group"..ChatId,GetUserReply[1]) 
...
Redis:srem(Thealhlfy.."alhlfy:BanGroup:Group"..ChatId,GetUserReply[1]) 
Redis:srem(Thealhlfy.."alhlfy:SilentGroup:Group"..ChatId,GetUserReply[1]) 
...
if Redis:sismember(Thealhlfy.."alhlfy:Num:okiktm"..ChatId, IdUser) then
return bot.answerCallbackQuery(data.id, "⇜ قمت بالتصويت مسبقاً", true)
end
Redis:sadd(Thealhlfy.."alhlfy:Num:okiktm"..ChatId, IdUser)  
local list = Redis:smembers(Thealhlfy.."alhlfy:Num:okiktm"..ChatId)
if #list >= tonumber(3) then
Redis:del(Thealhlfy.."alhlfy:Num:okiktm"..ChatId)
...
Redis:sadd(Thealhlfy.."alhlfy:SilentGroup:Group"..ChatId,GetUserReply) 
end
...
local UserInfo = bot.getUser(GetUserReply)
local Teext = ' ['..UserInfo.first_name..'](tg://user?id='..GetUserReply..')'
if Redis:sismember(Thealhlfy.."alhlfy:Num:noiktm"..ChatId, IdUser) then
return bot.answerCallbackQuery(data.id, "⇜ قمت بالتصويت مسبقاً", true)
end
Redis:sadd(Thealhlfy.."alhlfy:Num:noiktm"..ChatId, IdUser)  
local list = Redis:smembers(Thealhlfy.."alhlfy:Num:noiktm"..ChatId)
if #list >= tonumber(3) then
Redis:del(Thealhlfy.."alhlfy:Num:noiktm"..ChatId)
Redis:srem(Thealhlfy.."alhlfy:SilentGroup:Group"..ChatId,GetUserReply) 
...
if Text and Text:match('(.*)/yes_z/(.*)') then
  ...
  if tonumber(zwga_id) == tonumber(IdUser) then
    ...
    Redis:set(Thealhlfy..ChatId..zwga_id.."mtzwga:", zwg_id)
    Redis:set(Thealhlfy..ChatId..zwg_id.."mtzwga:", zwga_id)
...
if Text and Text:match('(%d+)/zeng') then
  ...
  if tonumber(UserId) == tonumber(IdUser) then
    Redis:set(Thealhlfy..ChatId..IdUser.."zkrf:", "zeng")
...
if name == "✂" then
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..ChatId..IdUser, 1)  
...
if Redis:get(Thealhlfy.."zwag_request:"..Data[1]) then
...
ballancee = Redis:get(Thealhlfy.."boob"..zwg_id) or 0
ballanceea = Redis:get(Thealhlfy.."boob"..zwga_id) or 0
zogtea = ballanceea + ballanceekkk
zeugh = ballancee - tonumber(coniss)
Redis:set(Thealhlfy.."boob"..zwg_id , math.floor(zeugh))
Redis:sadd(Thealhlfy.."roogg1",zwg_id)
Redis:sadd(Thealhlfy.."roogga1",zwga_id)
Redis:set(Thealhlfy.."roog1"..zwg_id,zwg_id)
Redis:set(Thealhlfy.."rooga1"..zwg_id,zwga_id)
Redis:set(Thealhlfy.."roogte1"..zwga_id,zwga_id)
Redis:set(Thealhlfy.."rahr1"..zwg_id,tonumber(coniss))
Redis:set(Thealhlfy.."rahr1"..zwga_id,tonumber(coniss))
Redis:set(Thealhlfy.."roog1"..zwga_id,zwg_id)
Redis:set(Thealhlfy.."rahrr1"..zwg_id,math.floor(ballanceekkk))
Redis:set(Thealhlfy.."rooga1"..zwga_id,zwga_id)
Redis:set(Thealhlfy.."rahrr1"..zwga_id,math.floor(ballanceekkk))
...
Redis:del(Thealhlfy.."zwag_request:"..UserId[1])
Redis:del(Thealhlfy.."zwag_request:"..UserId[2])
...
Redis:set(Thealhlfy..data.sender_user_id.."first_name:", F_Name)
...
ballancee = Redis:get(Thealhlfy.."tabbroat"..data.sender_user_id) or 0
...
zrfee = Redis:get(Thealhlfy.."rrfff"..data.sender_user_id) or 0
...
ballancee = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
doltebank = "🇸🇾"
Redis:set(Thealhlfy.."doltebank"..data.sender_user_id,doltebank)
cccall = Redis:get(Thealhlfy.."boobb"..data.sender_user_id)
ccctype = Redis:get(Thealhlfy.."bbobb"..data.sender_user_id)
shakse = Redis:get(Thealhlfy.."shkse"..data.sender_user_id)
if shakse == "طيبة" then
shakseshakse = "طيبة 😇"
else
shakseshakse = "شريرة 😈"
...
Redis:del(Thealhlfy..'SetChannelVip'..IdUser)
...
Redis:set(Thealhlfy..'SetChannelVip'..IdUser,true)
...
if Redis:get(Thealhlfy..'SetChannelVip'..IdUser) then 
if text =='الغاء' then 
...
Redis:del(Thealhlfy..'SetChannelVip'..IdUser)
Redis:set(Thealhlfy..'SOFI:Channel:Vip'..IdUser,text)
...
Redis:del(Thealhlfy..'SOFI:Channel:Vip'..IdUser)
Text = "⇜ تم حذف قناتك"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
shakse = "طيبة"
Redis:set(Thealhlfy.."shkse"..data.sender_user_id,shakse)
ttshakse = '⇜ اختر دولتك'
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
Redis:set(Thealhlfy.."bobna"..data.sender_user_id,news)
Redis:set(Thealhlfy.."boob"..data.sender_user_id,balas)
Redis:set(Thealhlfy.."boobb"..data.sender_user_id,creditcc)
Redis:set(Thealhlfy.."bbobb"..data.sender_user_id,mast)
Redis:set(Thealhlfy.."boballname"..creditcc,news)
Redis:set(Thealhlfy.."boballbalc"..creditcc,balas)
Redis:set(Thealhlfy.."boballcc"..creditcc,creditcc)
Redis:set(Thealhlfy.."boballban"..creditcc,mast)
Redis:set(Thealhlfy.."boballid"..creditcc,banid)
Redis:sadd(Thealhlfy.."booob",data.sender_user_id)
...
Redis:set(Thealhlfy.."bobna"..data.sender_user_id,news)
Redis:set(Thealhlfy.."boob"..data.sender_user_id,balas)
Redis:set(Thealhlfy.."boobb"..data.sender_user_id,creditvi)
Redis:set(Thealhlfy.."bbobb"..data.sender_user_id,visssa)
Redis:set(Thealhlfy.."boballname"..creditvi,news)
Redis:set(Thealhlfy.."boballbalc"..creditvi,balas)
Redis:set(Thealhlfy.."boballcc"..creditvi,creditvi)
Redis:set(Thealhlfy.."boballban"..creditvi,visssa)
Redis:set(Thealhlfy.."boballid"..creditvi,banid)
Redis:sadd(Thealhlfy.."booob",data.sender_user_id)
ttshakse = '⇜ اختر شخصيتك في اللعبة'
local reply_markup = bot.replyMarkup{
type = 'inline',
...
Redis:set(Thealhlfy.."bobna"..data.sender_user_id,news)
Redis:set(Thealhlfy.."boob"..data.sender_user_id,balas)
Redis:set(Thealhlfy.."boobb"..data.sender_user_id,creditex)
Redis:set(Thealhlfy.."bbobb"..data.sender_user_id,exprs)
Redis:set(Thealhlfy.."boballname"..creditex,news)
Redis:set(Thealhlfy.."boballbalc"..creditex,balas)
Redis:set(Thealhlfy.."boballcc"..creditex,creditex)
Redis:set(Thealhlfy.."boballban"..creditex,exprs)
Redis:set(Thealhlfy.."boballid"..creditex,banid)
Redis:sadd(Thealhlfy.."booob",data.sender_user_id)
ttshakse = '⇜ اختر شخصيتك في اللعبة'
local reply_markup = bot.replyMarkup{
type = 'inline',
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
cccall = Redis:get(Thealhlfy.."tdbelballance"..data.sender_user_id) or 0
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
if tonumber(ballance) < tonumber(cccall) then
return edit(ChatId,Msg_id, "⇜ فلوسك ماتكفي","md",true)
end
Redis:setex(Thealhlfy.."iioood" .. data.sender_user_id,920, true)
local list = {"1", "2", "3"}
local rand = list[math.random(#list)]
if rand == "1" then -- 1 con
cccallcc = tonumber(ballance) + tonumber(cccall)
Redis:set(Thealhlfy.."boob"..data.sender_user_id,cccallcc)
Redis:del(Thealhlfy.."tdbelballance"..data.sender_user_id)
...
cccallcc = tonumber(ballance) - tonumber(cccall)
Redis:set(Thealhlfy.."boob"..data.sender_user_id,cccallcc)
cccall = Redis:get(Thealhlfy.."tdbelballance"..data.sender_user_id)
Redis:del(Thealhlfy.."tdbelballance"..data.sender_user_id)
local convert_mony = string.format("%.0f",cccall)
local convert_monyy = string.format("%.0f",cccallcc)
msalm = "⌯ خسرت بالسحب ☹️\n\n⇜ المبلغ : "..convert_mony.."\nرصيدك الان : `"..convert_monyy.."`\n✧"
...
Redis:set(Thealhlfy.."boob"..data.sender_user_id,cccallcc)
namefram = Redis:get(Thealhlfy.."namefram"..data.sender_user_id)
Redis:sadd(Thealhlfy.."farmarname", namefram)
Redis:set(Thealhlfy.."sizefram"..data.sender_user_id,50000)
Redis:sadd(Thealhlfy.."ownerfram",data.sender_user_id)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
...
namefram = Redis:get(Thealhlfy.."namefram"..data.sender_user_id)
Redis:sadd(Thealhlfy.."farmarname", namefram)
Redis:set(Thealhlfy.."sizefram"..data.sender_user_id,100000)
Redis:sadd(Thealhlfy.."ownerfram",data.sender_user_id)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 8×8\n⇜ السعر : 100000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
namefram = Redis:get(Thealhlfy.."namefram"..data.sender_user_id)
Redis:sadd(Thealhlfy.."farmarname", namefram)
Redis:set(Thealhlfy.."sizefram"..data.sender_user_id,200000)
Redis:sadd(Thealhlfy.."ownerfram",data.sender_user_id)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 12×12\n⇜ السعر : 1000000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
namefram = Redis:get(Thealhlfy.."namefram"..data.sender_user_id)
Redis:sadd(Thealhlfy.."farmarname", namefram)
Redis:set(Thealhlfy.."sizefram"..data.sender_user_id,300000)
Redis:sadd(Thealhlfy.."ownerfram",data.sender_user_id)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 16×16\n⇜ السعر : 5000000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
namefram = Redis:get(Thealhlfy.."namefram"..data.sender_user_id)
Redis:sadd(Thealhlfy.."farmarname", namefram)
Redis:set(Thealhlfy.."sizefram"..data.sender_user_id,400000)
Redis:sadd(Thealhlfy.."ownerfram",data.sender_user_id)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 32×32\n⇜ السعر : 10000000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
if Redis:get(Thealhlfy.."mrkzplayer".."1"..data.sender_user_id) then
...
mrkzplayer = "مهاجم"
cityplayer = "🇺🇦 اوكرانيا"
Redis:set(Thealhlfy.."nameplayer".."1"..data.sender_user_id,nameplayer)
Redis:set(Thealhlfy.."energyplayer".."1"..data.sender_user_id,energyplayer)
Redis:set(Thealhlfy.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."1"..data.sender_user_id,39000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
if Redis:get(Thealhlfy.."mrkzplayer".."4"..data.sender_user_id) then
...
mrkzplayer = "مدافع"
cityplayer = "البرازيل 🇧🇷"
Redis:set(Thealhlfy.."nameplayer".."4"..data.sender_user_id,nameplayer)
Redis:set(Thealhlfy.."energyplayer".."4"..data.sender_user_id,energyplayer)
Redis:set(Thealhlfy.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."4"..data.sender_user_id,50000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
if Redis:get(Thealhlfy.."mrkzplayer".."3"..data.sender_user_id) then
...
Redis:set(Thealhlfy.."nameplayer".."3"..data.sender_user_id,nameplayer)
Redis:set(Thealhlfy.."energyplayer".."3"..data.sender_user_id,energyplayer)
Redis:set(Thealhlfy.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."3"..data.sender_user_id,70000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."4"..data.sender_user_id,40000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."3"..data.sender_user_id,20000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : خوان ماتا\n⇜ مركزه : وسط\n⇜ طاقة اللاعب : 81\n⇜ الجنسية : إسبانيا 🇪🇸 \n⇜ السعر : 20000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Thealhlfy.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."4"..data.sender_user_id,15000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."1"..data.sender_user_id,100000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."4"..data.sender_user_id,20000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."4"..data.sender_user_id,30000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
if Redis:get(Thealhlfy.."mrkzplayer".."5"..data.sender_user_id) then
...
mrkzplayer = "حارس"
cityplayer = "ألمانيا 🇩🇪 "
Redis:set(Thealhlfy.."nameplayer".."5"..data.sender_user_id,nameplayer)
Redis:set(Thealhlfy.."energyplayer".."5"..data.sender_user_id,energyplayer)
Redis:set(Thealhlfy.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."5"..data.sender_user_id,110000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : تير شتيجن\n⇜ مركزه : حارس\n⇜ طاقة اللاعب : 91\n⇜ الجنسية : ألمانيا 🇩🇪 \n⇜ السعر : 110000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
if Redis:get(Thealhlfy.."mrkzplayer".."2"..data.sender_user_id) then
...
mrkzplayer = "جناح"
cityplayer = "فرنسا 🇫🇷 "
Redis:set(Thealhlfy.."nameplayer".."2"..data.sender_user_id,nameplayer)
Redis:set(Thealhlfy.."energyplayer".."2"..data.sender_user_id,energyplayer)
Redis:set(Thealhlfy.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."2"..data.sender_user_id,45000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."2"..data.sender_user_id,78000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : رودريغو\n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : البرازيل 🇧🇷\n⇜ السعر : 78000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Thealhlfy.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."4"..data.sender_user_id,65000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : ميليتاو\n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : البرازيل 🇧🇷\n⇜ السعر : 65000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Thealhlfy.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."4"..data.sender_user_id,73000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : الابا\n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : النمسا 🇦🇹 \n⇜ السعر : 73000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Thealhlfy.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."2"..data.sender_user_id,180000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : فينيسيوس \n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 94\n⇜ الجنسية : البرازيل 🇧🇷 \n⇜ السعر : 180000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Thealhlfy.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."2"..data.sender_user_id,55000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : دي ماريا \n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 85\n⇜ الجنسية : الأرجنتين 🇦🇷 \n⇜ السعر : 55000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Thealhlfy.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."4"..data.sender_user_id,38000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : دانييلي \n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 84\n⇜ الجنسية : إيطاليا 🇮🇹 \n⇜ السعر : 38000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Thealhlfy.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."1"..data.sender_user_id,55000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."5"..data.sender_user_id,99000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : دوناروما \n⇜ مركزه : حارس\n⇜ طاقة اللاعب : 89\n⇜ الجنسية : إيطاليا 🇮🇹 \n⇜ السعر : 99000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Thealhlfy.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."4"..data.sender_user_id,55000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."2"..data.sender_user_id,59000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."4"..data.sender_user_id,170000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : ايدن ازارد \n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 93\n⇜ الجنسية : اسبانيا 🇪🇸 \n⇜ السعر : 170000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Thealhlfy.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."1"..data.sender_user_id,60000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : فرمينو \n⇜ مركزه : مهاجم\n⇜ طاقة اللاعب : 86\n⇜ الجنسية : البرازيل 🇧🇷 \n⇜ السعر : 60000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Thealhlfy.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."1"..data.sender_user_id,19000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : جاك كلارك \n⇜ مركزه : مهاجم\n⇜ طاقة اللاعب : 81\n⇜ الجنسية : إنجلترا 🏴󠁧󠁢󠁥󠁮󠁧󠁿 \n⇜ السعر : 19000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Thealhlfy.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."1"..data.sender_user_id,53000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."1"..data.sender_user_id,41000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : توريس \n⇜ مركزه : مهاجم\n⇜ طاقة اللاعب : 84\n⇜ الجنسية : اسبانيا 🇪🇸 \n⇜ السعر : 41000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Thealhlfy.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."3"..data.sender_user_id,41000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."3"..data.sender_user_id,74000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."3"..data.sender_user_id,78000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : بول بوجبا \n⇜ مركزه : وسط\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : فرنسا 🇫🇷 \n⇜ السعر : 78000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Thealhlfy.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."3"..data.sender_user_id,90000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."5"..data.sender_user_id,80000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."5"..data.sender_user_id,70000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."5"..data.sender_user_id,52000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."5"..data.sender_user_id,20000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."5"..data.sender_user_id,40000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."1"..data.sender_user_id,20000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."2"..data.sender_user_id,100000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : محمد صلاح\n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 91\n⇜ الجنسية : مصر 🇪🇬 \n⇜ السعر : 100000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Thealhlfy.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."2"..data.sender_user_id,90000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : نيمار\n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 90\n⇜ الجنسية : السنغال 🇸🇳 \n⇜ السعر : 90000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Thealhlfy.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Thealhlfy.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Thealhlfy.."priceplayer".."2"..data.sender_user_id,80000)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."boob"..data.sender_user_id,cccallcc)
lkbnade = Redis:get(Thealhlfy.."lkbnade"..data.sender_user_id)
Redis:sadd(Thealhlfy.."lkbnadesadd", lkbnade)
namenade = "ريال مدريد"
Redis:set(Thealhlfy.."namenade"..data.sender_user_id,namenade)
Redis:set(Thealhlfy.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Thealhlfy.."ownernade",data.sender_user_id)
Redis:set(Thealhlfy.."energynade"..data.sender_user_id,50)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Thealhlfy.."ownernade",data.sender_user_id)
Redis:set(Thealhlfy.."energynade"..data.sender_user_id,45)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : برشلونة\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 150000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Thealhlfy.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Thealhlfy.."ownernade",data.sender_user_id)
Redis:set(Thealhlfy.."energynade"..data.sender_user_id,40)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : تشيلسي\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 90000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Thealhlfy.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Thealhlfy.."ownernade",data.sender_user_id)
Redis:set(Thealhlfy.."energynade"..data.sender_user_id,35)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Thealhlfy.."ownernade",data.sender_user_id)
Redis:set(Thealhlfy.."energynade"..data.sender_user_id,30)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : ليفربول\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 120000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Thealhlfy.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Thealhlfy.."ownernade",data.sender_user_id)
Redis:set(Thealhlfy.."energynade"..data.sender_user_id,25)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Thealhlfy.."ownernade",data.sender_user_id)
Redis:set(Thealhlfy.."energynade"..data.sender_user_id,20)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Thealhlfy.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Thealhlfy.."ownernade",data.sender_user_id)
Redis:set(Thealhlfy.."energynade"..data.sender_user_id,15)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : يوفنتوس\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 40000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Thealhlfy.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Thealhlfy.."ownernade",data.sender_user_id)
Redis:set(Thealhlfy.."energynade"..data.sender_user_id,10)
ballance = Redis:get(Thealhlfy.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : ارسنال\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 20000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
if Redis:get(Thealhlfy.."hazrlock"..ChatId) == UserId then
if Redis:sismember(Thealhlfy.."listhzerid"..ChatId, IdUser) then
return bot.answerCallbackQuery(data.id, "⇜ لقد انضممت الى اللعبة مسبقاً ", true)
end
if tonumber(Redis:get(Thealhlfy.."hazrmalek"..ChatId)) == IdUser then
return bot.answerCallbackQuery(data.id, "⇜ انتا مالك اللعبة حاليا", true)
end
Redis:sadd(Thealhlfy.."listhzerid"..ChatId, IdUser)
...
if Redis:get(Thealhlfy.."soundidche"..ChatId..IdUser) == UserId[1] then
...
sleep(1)
os.remove(""..title..".mp3")
Redis:del(Thealhlfy.."soundidche"..ChatId..IdUser)
else
Redis:del(Thealhlfy.."soundidche"..ChatId..IdUser)
...
if Redis:get(Thealhlfy.."youtidche"..ChatId..IdUser) == UserId[1] then
...
sleep(1)
os.remove(""..title..".mp3")
Redis:del(Thealhlfy.."youtidche"..ChatId..IdUser)
else
Redis:del(Thealhlfy.."youtidche"..ChatId..IdUser)
return edit(ChatId,Msg_id,'\n⇜ لا استطيع تحميل اكثر من 25 ميغا',"md",true)
end
...
local kk_id = Redis:get(Thealhlfy.."kk_Akab"..ChatId)
if Redis:sismember(Thealhlfy..'members_Ahkamm'..ChatId,IdUser) then
Redis:sadd(Thealhlfy.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
local kk_id = Redis:get(Thealhlfy.."kk_Akab"..ChatId)
if Redis:sismember(Thealhlfy..'members_Ahkamm'..ChatId,IdUser) then
Redis:srem(Thealhlfy.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{{text = 'Louis', url = 't.me/Y88F8'},},}}
...
local ff_id = Redis:get(Thealhlfy.."ff_Ahkam"..ChatId)
local kk_id = Redis:get(Thealhlfy.."kk_Ahkam"..ChatId)
...
local ff_id = Redis:get(Thealhlfy.."ff_Ahkkam"..ChatId)
local kk_id = Redis:get(Thealhlfy.."kk_Ahkkam"..ChatId)
if tonumber(IdUser) == tonumber(ff_id) then
Redis:sadd(Thealhlfy.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
...
local kk_id = Redis:get(Thealhlfy.."kk_koorsi"..ChatId)
if Redis:sismember(Thealhlfy..'List_Koorsi'..ChatId,IdUser) then
Redis:sadd(Thealhlfy.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
local ff_id = Redis:get(Thealhlfy.."ff_saraha"..ChatId)
local kk_id = Redis:get(Thealhlfy.."kk_saraha"..ChatId)
if tonumber(IdUser) == tonumber(ff_id) then
Redis:sadd(Thealhlfy.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
...
if not Redis:sismember(Thealhlfy..'List_Aktooh'..ChatId,IdUser) then 
Redis:sadd(Thealhlfy..'List_Aktooh'..ChatId,IdUser)
Redis:setex(Thealhlfy.."Witting_StartGameAk"..ChatId,1400,true)
local list = Redis:smembers(Thealhlfy..'List_Aktooh'..ChatId) 
if #list == 2 then
for k,v in pairs(list) do
if k == 1 then
...
if k == #list then
local Ak_Tm = Redis:get(Thealhlfy.."Ak_Tmooh"..ChatId)
local ban = bot.getUser(Ak_Tm)
local AkName = '['..ban.first_name..'](tg://user?id='..ban.id..')' or 'لا يوجد اسم'
local message = '*✦┊عـدد المصـوتين ⇜*'..#list..' \n*✦┊اسمـاء المصـوتين ⇩*\n'..name1..'\n'..name2..'\n'..name3..'\n\n*✦┊المستخـدم* '..AkName..'\n*✦┊تم كتمـه .. بنجـاح ✓*'
Redis:sadd(Thealhlfy.."SilentGroup:Group"..ChatId,Ak_Tm) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
---------------------- Dev ZilZal ----------------------
if Text == '/Unaktmooh' and Redis:get(Thealhlfy.."Witting_StartGameAk"..ChatId) then
local raeaktooh = Redis:get(Thealhlfy.."raeaktooh"..ChatId)
...
Redis:srem(Thealhlfy.."SilentGroup:Group"..ChatId,Ak_Tm)
Redis:srem(Thealhlfy..'List_Aktooh'..ChatId,UserName) 
Redis:del(Thealhlfy..'raeaktooh'..ChatId) 
Redis:del(Thealhlfy..'List_Aktooh'..ChatId) 
Redis:del(Thealhlfy.."Witting_StartGameAk"..ChatId)
Redis:del(Thealhlfy.."Start_Aktmooh"..ChatId)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
if not Redis:sismember(Thealhlfy..'List_Ahkkam'..ChatId,IdUser) then 
Redis:sadd(Thealhlfy..'List_Ahkkam'..ChatId,IdUser)
Redis:setex(Thealhlfy.."Witting_StartGameeh"..ChatId,1400,true)
local list = Redis:smembers(Thealhlfy..'List_Ahkkam'..ChatId) 
if #list == 2 then
local UserInfo = bot.getUser(IdUser)
...
---------------------- Dev ZilZal ----------------------
if Text == '/startahkam' and Redis:get(Thealhlfy.."Witting_StartGameeh"..ChatId) then
local rarahkam = Redis:get(Thealhlfy.."raeahkkam"..ChatId)
...
Redis:set(Thealhlfy.."kk_Ahkkam"..ChatId,UserId_Info.id)
Redis:srem(Thealhlfy..'List_Ahkkam'..ChatId,UserName) 
local liiist = Redis:smembers(Thealhlfy..'List_Ahkkam'..ChatId) 
...
Redis:set(Thealhlfy.."ff_Ahkkam"..ChatId,UserId2_Info.id)
local GetLike = Redis:incrby(Thealhlfy.."Num:Add:Ahkam"..ChatId..UserId2_Info.id, 5) 
Redis:hset(Thealhlfy..':GroupUserCountAhkam:'..ChatId,UserId2_Info.id,GetLike)
...
NameLUser = NameLUser:gsub("[[]","")
Redis:hset(Thealhlfy..':GroupAhkamNameUser:'..ChatId,UserrInfo.id,NameLUser)
Redis:del(Thealhlfy..'raeahkkam'..ChatId) 
Redis:del(Thealhlfy..'List_Ahkkam'..ChatId) 
Redis:del(Thealhlfy.."Witting_StartGameeh"..ChatId)
Redis:del(Thealhlfy.."Start_Ahkkam"..ChatId)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
---------------------- Dev ZilZal ----------------------
if Text == '/Koorsy' then
if not Redis:sismember(Thealhlfy..'List_Koorsi'..ChatId,IdUser) then 
Redis:sadd(Thealhlfy..'List_Koorsi'..ChatId,IdUser)
Redis:setex(Thealhlfy.."Witting_StartGameek"..ChatId,1400,true)
local list = Redis:smembers(Thealhlfy..'List_Koorsi'..ChatId) 
if #list == 2 then
local UserInfo = bot.getUser(IdUser)
local Teext = '- ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..IdUser..')'
...
---------------------- Dev ZilZal ----------------------
if Text == '/startkoorsi' and Redis:get(Thealhlfy.."Witting_StartGameek"..ChatId) then
local rarahkam = Redis:get(Thealhlfy.."raekoorsi"..ChatId)
if tonumber(IdUser) == tonumber(rarahkam) then
local list = Redis:smembers(Thealhlfy..'List_Koorsi'..ChatId) 
local UserName = list[math.random(#list)]
local UserId_Info = bot.getUser(UserName)
...
Redis:set(Thealhlfy.."koorsi:"..testkoorsi.."chat_id", ChatId)
Redis:set(Thealhlfy.."koorsi:"..testkoorsi.."to", UserId_Info.id)
Redis:set(Thealhlfy.."koorsi:"..testkoorsi.."msg_id",Msg_id)
if UserId_Info.username and UserId_Info.username ~= "" then
ls = '['..UserId_Info.first_name..'](tg://user?id='..UserName..')'
else
ls = '['..UserId_Info.first_name..'](tg://user?id='..UserName..')'
end
Redis:set(Thealhlfy.."kk_koorsi"..ChatId,UserId_Info.id)
Redis:srem(Thealhlfy..'List_Koorsi'..ChatId,UserName) 
Redis:del(Thealhlfy..'raekoorsi'..ChatId) 
Redis:del(Thealhlfy..'List_Koorsi'..ChatId) 
Redis:del(Thealhlfy.."Witting_StartGameek"..ChatId)
Redis:del(Thealhlfy.."Start_Koorsi"..ChatId)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(Thealhlfy..'List_Saraha'..ChatId,IdUser) then 
Redis:sadd(Thealhlfy..'List_Saraha'..ChatId,IdUser)
Redis:setex(Thealhlfy.."Witting_StartGameS"..ChatId,1400,true)
local list = Redis:smembers(Thealhlfy..'List_Saraha'..ChatId) 
if #list == 2 then
local UserInfo = bot.getUser(IdUser)
local Teext = '- ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..IdUser..')'
local zzllzz = '*✦┊عـدد اللاعبيـن ⇜*'..#list..' \n*✦┊لقـد انضـم للعبـة كرسـي ⇩*\n'..Teext
...
---------------------- صراحه ----------------------
if Text == '/startsaraha' and Redis:get(Thealhlfy.."Witting_StartGameS"..ChatId) then
local rarahkam = Redis:get(Thealhlfy.."raesaraha"..ChatId)
if tonumber(IdUser) == tonumber(rarahkam) then
local list = Redis:smembers(Thealhlfy..'List_Saraha'..ChatId) 
local UserName = list[math.random(#list)]
local UserId_Info = bot.getUser(UserName)
local testsaraha = math.random(1,9999999999999)
Redis:set(Thealhlfy.."saraha:"..testsaraha.."chat_id", ChatId)
Redis:set(Thealhlfy.."saraha:"..testsaraha.."to", UserId_Info.id)
Redis:set(Thealhlfy.."saraha:"..testsaraha.."msg_id",Msg_id)
if UserId_Info.username and UserId_Info.username ~= "" then
ls = '['..UserId_Info.first_name..'](tg://user?id='..UserName..')'
else
ls = '['..UserId_Info.first_name..'](tg://user?id='..UserName..')'
end
Redis:set(Thealhlfy.."kk_saraha"..ChatId,UserId_Info.id)
Redis:srem(Thealhlfy..'List_Saraha'..ChatId,UserName) 
local liiiist = Redis:smembers(Thealhlfy..'List_Saraha'..ChatId) 
local User2Name = liiiist[math.random(#liiiist)]
local UserId2_Info = bot.getUser(User2Name)
Redis:incrby(Thealhlfy..'Num:Add:Games'..ChatId..UserId2_Info.id,5)
Redis:set(Thealhlfy.."ff_saraha"..ChatId,UserId2_Info.id)
Redis:del(Thealhlfy..'raesaraha'..ChatId) 
Redis:del(Thealhlfy..'List_Saraha'..ChatId) 
Redis:del(Thealhlfy.."Witting_StartGameS"..ChatId)
Redis:del(Thealhlfy.."Start_Saraha"..ChatId)
local liiist = Redis:sismember(Thealhlfy..'List_Saraha'..ChatId,IdUser)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:sismember(Thealhlfy..'List_Ahkamm'..ChatId,IdUser) then
return bot.answerCallbackQuery(data.id, "✦┊انت منضـم مسبقـاً .. الـى اللعبـه", true)
end
bot.answerCallbackQuery(data.id, "✦ تم ضفتك للعبـة ⛓ ✓", true)
Redis:sadd(Thealhlfy..'List_Ahkamm'..ChatId,IdUser)
Redis:sadd(Thealhlfy..'members_Ahkamm'..ChatId,IdUser)
Redis:setex(Thealhlfy.."Witting_StartGamehh"..ChatId,1400,true)
end
if Text and Text:match('/Ahkam(.*)') then
local UserId = Text:match('/Ahkam(.*)')
if Redis:sismember(Thealhlfy..'List_Ahkam'..ChatId,IdUser) then
return bot.answerCallbackQuery(data.id, "✦┊انت منضـم مسبقـاً .. الـى اللعبـه", true)
end
bot.answerCallbackQuery(data.id, "✦ تم ضفتك للعبـة 👩🏻‍⚖⚖ ✓", true)
Redis:sadd(Thealhlfy..'List_Ahkam'..ChatId,IdUser)
Redis:setex(Thealhlfy.."Witting_StartGameh"..ChatId,1400,true)
end
if Text and Text:match('/Korsy(.*)') then
local UserId = Text:match('/Korsy(.*)')
if Redis:sismember(Thealhlfy..'List_Korsi'..ChatId,IdUser) then
return bot.answerCallbackQuery(data.id, "✦┊انت منضـم مسبقـاً .. الـى اللعبـه", true)
end
bot.answerCallbackQuery(data.id, "✦ تم ضفتك للعبـة ⛓ ✓", true)
Redis:sadd(Thealhlfy..'List_Korsi'..ChatId,IdUser)
Redis:setex(Thealhlfy.."Witting_StartGamek"..ChatId,1400,true)
end
if Text and Text:match('/Sarahy(.*)') then
local UserId = Text:match('/Sarahy(.*)')
if Redis:sismember(Thealhlfy..'List_Saraha'..ChatId,IdUser) then
return bot.answerCallbackQuery(data.id, "✦┊انت منضـم مسبقـاً .. الـى اللعبـه", true)
end
bot.answerCallbackQuery(data.id, "✦ تم ضفتك للعبـة ⛓ ✓", true)
Redis:sadd(Thealhlfy..'List_Saraha'..ChatId,IdUser)
...
if Text and Text:match('(%d+)/startttahkam') and Redis:get(Thealhlfy.."Witting_StartGameh"..ChatId) then
local UserId = Text:match('(%d+)/startttahkam')
local rarahkam = Redis:get(Thealhlfy.."raeahkam"..ChatId)
if tonumber(IdUser) ~= tonumber(rarahkam) then
return bot.answerCallbackQuery(data.id, "✦┊الامـر للي بـدأ اللعبـه ...", true)
else
local list = Redis:smembers(Thealhlfy..'List_Ahkam'..ChatId) 
local UserName = list[math.random(#list)]
local UserId_Info = bot.getUser(UserName)
if UserId_Info.username and UserId_Info.username ~= "" then
ls = '['..UserId_Info.first_name..'](tg://user?id='..UserName..')'
...
Redis:set(Thealhlfy.."kk_Ahkam"..ChatId,UserId_Info.id)
Redis:srem(Thealhlfy..'List_Ahkam'..ChatId,UserId_Info.id) 
...
Redis:set(Thealhlfy.."ff_Ahkam"..ChatId,UserId2_Info.id)
Redis:incrby(Thealhlfy..'Num:Add:Ahkam'..ChatId..UserId2_Info.id,5)
Redis:del(Thealhlfy..'raeahkam'..ChatId) 
Redis:del(Thealhlfy..'List_Ahkam'..ChatId) 
Redis:del(Thealhlfy.."Witting_StartGameh"..ChatId)
Redis:del(Thealhlfy.."Start_Ahkam"..ChatId)
local Thealhlfy = '*⚖┊تم إختيار الشخـص ⇜* '..ls..'\n*👩🏻‍⚖┊ليتـم الحكـم عليـه من قبـل ⇜* '..Hs..'\n\n*🎁┊وتم اضـافـة 5 نقـاط للحـاكـم*'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹𓌗 قنـاة البـوت 𓌗.',url='http://t.me/'..chsource..''}},
}
local msg_idd = Msg_id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token..'/editMessageText?chat_id='..data.id..'&text='..URL.escape(Thealhlfy)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Spam"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Keyboard"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:vico"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Animation"..ChatId,"del")
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Document"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:text"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Video"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Photo"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:User:Name"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:hashtak"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:forward"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Audio"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Sticker"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Contact"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Join"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Unsupported"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:lockpin"..ChatId,(bot.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:tagservr"..ChatId,true)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Markdaun"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:edit"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:geam"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Thealhlfy.."alhlfy:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Link"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Spam"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:vico"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Animation"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Document"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Video"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Photo"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:User:Name"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:hashtak"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:forward"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Audio"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Sticker"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Contact"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:geam"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Thealhlfy.."alhlfy:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Link"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Spam"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:vico"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Animation"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Document"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Video"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Photo"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:forward"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Audio"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Contact"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:geam"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Thealhlfy.."alhlfy:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Link"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Spam"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:vico"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Animation"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Document"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Video"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Photo"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:User:Name"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:hashtak"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:forward"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Audio"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Sticker"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Contact"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:geam"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Thealhlfy.."alhlfy:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Status:Link"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Status:Welcome"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Status:Id"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Status:IdPhoto"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Status:Reply"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Status:ReplySudo"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Status:SetId"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Status:BanId"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Status:Games"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Status:KickMe"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Status:Link"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Status:Welcome"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Status:Id"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Status:IdPhoto"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Status:Reply"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Status:ReplySudo"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Status:SetId"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Status:BanId"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Status:Games"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Status:KickMe"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Thealhlfy.."alhlfy:TheBasicsQ:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Thealhlfy.."alhlfy:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(Thealhlfy.."alhlfy:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Thealhlfy..'alhlfy:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'ا','ايدي')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'م','رفع مميز')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'اد', 'رفع ادمن')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'مد','رفع مدير')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'منش', 'رفع منشئ')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'اس', 'رفع منشئ اساسي')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'مط','رفع M')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'تن','تنزيل الكل')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'را','الرابط')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'رر','الردود')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'،،','مسح المكتومين')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'رد','اضف رد')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'غ','غنيلي')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'رس','رسائلي')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'ثانوي','رفع مطور ثانوي')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'مس','مسح تعديلاتي')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'ن','نقاطي')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'س','اسالني')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'ل','لغز')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'مع','معاني')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'ح','حزوره')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'رف','رفع القيود')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'الغ','الغاء حظر')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'ث','تثبيت')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'ك','كشف')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'تت','تاك')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'تك','تاك للكل')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'تغ','تغيير الايدي')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'تنز','تنزيل جميع الرتب')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'قق','قفل الاشعارات')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'فف','فتح الاشعارات')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'مر','مسح رد')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'امر','اضف امر')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'ش','شعر')
Redis:set(Thealhlfy.."alhlfy:Get:Reides:Commands:Group"..UserId[2]..":"..'غغ','اغنيه')
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:Link"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:farsia"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:tphlesh"..ChatId)  
Redis:del(Thealhlfy.."alhlfy:Status:IdPhoto"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:phshar"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:farsia"..ChatId,true)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:tphlesh"..ChatId,true)
Redis:set(Thealhlfy.."alhlfy:Status:IdPhoto"..ChatId,true)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thealhlfy.."alhlfy:Lock:phshar"..ChatId,true)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:Spam"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:Keyboard"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:vico"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:Animation"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:Document"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:text"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:Video"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:Photo"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:User:Name"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:hashtak"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:Bot:kick"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:forward"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:Audio"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:Sticker"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:Contact"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:Join"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:AddMempar"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:Unsupported"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:lockpin"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:tagservr"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:Markdaun"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:edit"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Lock:geam"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(Thealhlfy.."alhlfy:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:DevelopersQ:Groups") 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Developers:Groups") 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:ControlAll:Groups") 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:TheBasicsQ:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:MalekAsase:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:TheBasics:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Originators:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Managers:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Addictive:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:Distinguished:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:KtmAll:Groups") 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:BanAll:Groups") 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:BanGroup:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thealhlfy.."alhlfy:SilentGroup:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
