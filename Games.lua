...
if Redis:get(Thealhlfy.."alhlfy:Game:Smile"..msg.chat_id) then
if text == Redis:get(Thealhlfy.."alhlfy:Game:Smile"..msg.chat_id) then
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
Redis:del(Thealhlfy.."alhlfy:Game:Smile"..msg.chat_id)
local Num = Redis:get(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true)  
end
end 
if Redis:get(Thealhlfy.."alhlfy:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(Thealhlfy.."alhlfy:Game:Monotonous"..msg.chat_id) then
Redis:del(Thealhlfy.."alhlfy:Game:Monotonous"..msg.chat_id)
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
end 
if Redis:get(Thealhlfy.."alhlfy:Game:alam"..msg.chat_id) then
if text == Redis:get(Thealhlfy.."alhlfy:Game:alam"..msg.chat_id) then
Redis:del(Thealhlfy.."alhlfy:Game:alam"..msg.chat_id)
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
end 
if Redis:get(Thealhlfy.."alhlfy:Game:ausm"..msg.chat_id) then
if text == Redis:get(Thealhlfy.."alhlfy:Game:ausm"..msg.chat_id) then
Redis:del(Thealhlfy.."alhlfy:Game:ausm"..msg.chat_id)
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
end 
if Redis:get(Thealhlfy.."alhlfy:Game:Riddles"..msg.chat_id) then
if text == Redis:get(Thealhlfy.."alhlfy:Game:Riddles"..msg.chat_id) then
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
Redis:del(Thealhlfy.."alhlfy:Game:Riddles"..msg.chat_id)
local Num = Redis:get(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
end
if Redis:get(Thealhlfy.."alhlfy:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(Thealhlfy.."alhlfy:Game:Meaningof"..msg.chat_id) then
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
Redis:del(Thealhlfy.."alhlfy:Game:Meaningof"..msg.chat_id)
local Num = Redis:get(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
end
if Redis:get(Thealhlfy.."alhlfy:Game:Reflection"..msg.chat_id) then
if text == Redis:get(Thealhlfy.."alhlfy:Game:Reflection"..msg.chat_id) then
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
Redis:del(Thealhlfy.."alhlfy:Game:Reflection"..msg.chat_id)
local Num = Redis:get(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
end
if Redis:get(Thealhlfy.."alhlfy:Game:Estimate"..msg.chat_id..msg.sender_id.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return send(msg_chat_id,msg_id,"⇜ مايمديك تخمن عدد اكبر من ( 20 ) خمن رقم ما بين ( 1 - 20 )\n","md",true)
end 
local GETNUM = Redis:get(Thealhlfy.."alhlfy:Game:Estimate"..msg.chat_id..msg.sender_id.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(Thealhlfy.."alhlfy:SADD:NUM"..msg.chat_id..msg.sender_id.user_id)
Redis:del(Thealhlfy.."alhlfy:Game:Estimate"..msg.chat_id..msg.sender_id.user_id)
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id,5)  
return send(msg_chat_id,msg_id,"⇜ مبروك فزت وخمنت الرقم الصحيح\n⇜ تم اضافة لك ( 5 ) نقاط \n✧","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(Thealhlfy.."alhlfy:SADD:NUM"..msg.chat_id..msg.sender_id.user_id,1)
if tonumber(Redis:get(Thealhlfy.."alhlfy:SADD:NUM"..msg.chat_id..msg.sender_id.user_id)) >= 3 then
Redis:del(Thealhlfy.."alhlfy:SADD:NUM"..msg.chat_id..msg.sender_id.user_id)
Redis:del(Thealhlfy.."alhlfy:Game:Estimate"..msg.chat_id..msg.sender_id.user_id)
...
if Redis:get(Thealhlfy.."alhlfy:Game:Difference"..msg.chat_id) then
if text == Redis:get(Thealhlfy.."alhlfy:Game:Difference"..msg.chat_id) then 
Redis:del(Thealhlfy.."alhlfy:Game:Difference"..msg.chat_id)
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
end
if Redis:get(Thealhlfy.."alhlfy:Game:Example"..msg.chat_id) then
if text == Redis:get(Thealhlfy.."alhlfy:Game:Example"..msg.chat_id) then 
Redis:del(Thealhlfy.."alhlfy:Game:Example"..msg.chat_id)
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
...
if Redis:get(Thealhlfy.."gamebot:Set:Manager:rd"..msg.sender_id.user_id..":"..msg.chat_id) == "true" then
Redis:set(Thealhlfy.."gamebot:Set:Manager:rd"..msg.sender_id.user_id..":"..msg.chat_id,"true1uu")
Redis:sadd(Thealhlfy.."gamebot:List:Manager", text)
return send(msg.chat_id,msg.id,'\n⇜ تم حفظ السؤال')
end
end
if text and text:match("^(.*)$") then
if Redis:get(Thealhlfy.."gamebot:Set:Manager:rdd"..msg.sender_id.user_id..":"..msg.chat_id) == "true" then
Redis:set(Thealhlfy.."gamebot:Set:Manager:rdd"..msg.sender_id.user_id..":"..msg.chat_id,"true1uu")
Redis:srem(Thealhlfy.."gamebot:List:Manager", text)
return send(msg.chat_id,msg.id,'\n⇜ تم مسح السؤال')
end
end
if Redis:get(Thealhlfy.."Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'start' then
if msg.content.audio then  
Redis:set(Thealhlfy.."audio:Games"..msg.sender_id.user_id..":"..msg.chat_id,msg.content.audio.audio.remote.id)  
Redis:sadd(Thealhlfy.."audio:Games:Bot",msg.content.audio.audio.remote.id)  
Redis:set(Thealhlfy.."Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id,'started')
return send(msg.chat_id, msg.id,'⇜ ارسل الجواب الان ...')
end   
end
if Redis:get(Thealhlfy.."Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'started' then
local Id_audio = Redis:get(Thealhlfy.."audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
Redis:set(Thealhlfy..'Text:Games:audio'..Id_audio,text)
Redis:del(Thealhlfy.."Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
return send(msg.chat_id, msg.id,'⇜ تم حفظ السؤال والجواب')
end

if Redis:get(Thealhlfy..'Games:Set:Answer'..msg.chat_id) then
if text == ""..(Redis:get(Thealhlfy..'Games:Set:Answer'..msg.chat_id) or '66765$47').."" then 
Redis:del(Thealhlfy.."Games:Set:Answer"..msg.chat_id)
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id,5)  
Redis:del(Thealhlfy.."Games:Set:Answer"..msg.chat_id)
local Num = Redis:get(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك ( 5 ) نقاط\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
...
if Redis:get(Thealhlfy.."alhlfy:All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'startdel' then
if not Redis:sismember(Thealhlfy.."alhlfy:All:text:Games:Bot",text) then
send(msg_chat_id,msg_id,'⇜ لا يوجد صوت بهذا الاسم عام')
Redis:del(Thealhlfy.."alhlfy:All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
return false
end
Redis:del(Thealhlfy.."alhlfy:All:audio:Games"..text)
Redis:srem(Thealhlfy.."alhlfy:All:text:Games:Bot",text)  
Redis:del(Thealhlfy.."alhlfy:All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
send(msg_chat_id,msg_id,'⇜ تم مسح الصوت بنجاح')
return false
end
if Redis:get(Thealhlfy.."alhlfy:All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'start' then
Redis:set(Thealhlfy..'alhlfy:All:Text:Games:audio'..msg.chat_id,text)
Redis:sadd(Thealhlfy.."alhlfy:All:text:Games:Bot",text)  
Redis:set(Thealhlfy.."alhlfy:All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id,'started')
send(msg_chat_id,msg_id,'⇜ ارسل الصوت ليتم حفظه باسم : '..text)
return false
end
if Redis:get(Thealhlfy.."alhlfy:All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'started' then
if msg.content.audio then  
local nameaudio = Redis:get(Thealhlfy..'alhlfy:All:Text:Games:audio'..msg.chat_id)
Redis:set(Thealhlfy.."alhlfy:All:audio:Games"..nameaudio,msg.content.audio.audio.remote.id)  
Redis:del(Thealhlfy.."alhlfy:All:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
send(msg_chat_id,msg_id,'⇜ تم حفظ الصوت باسم : '..nameaudio)
return false
end   
end
if text and not Redis:get(Thealhlfy..'lock_geamsAudio'..msg.chat_id) then
local nameaudio = Redis:get(Thealhlfy.."alhlfy:All:audio:Games"..text)
if nameaudio then
bot.sendAudio(msg_chat_id, msg.id,nameaudio , '', "md") 
end
end
if Redis:get(Thealhlfy.."alhlfy:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'startdel' then
if not Redis:sismember(Thealhlfy.."alhlfy:text:Games:Bot"..msg.chat_id,text) then
send(msg_chat_id,msg_id,'⇜ لا يوجد صوت بهذا الاسم في القروب')
Redis:del(Thealhlfy.."alhlfy:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
return false
end
Redis:del(Thealhlfy.."alhlfy:audio:Games"..msg.chat_id..text)
Redis:srem(Thealhlfy.."alhlfy:text:Games:Bot"..msg.chat_id,text)  
Redis:del(Thealhlfy.."alhlfy:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
send(msg_chat_id,msg_id,'⇜ تم مسح الصوت بنجاح')
return false
end
if Redis:get(Thealhlfy.."alhlfy:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'start' then
Redis:set(Thealhlfy..'alhlfy:Text:Games:audio'..msg.chat_id,text)
Redis:sadd(Thealhlfy.."alhlfy:text:Games:Bot"..msg.chat_id,text)  
Redis:set(Thealhlfy.."alhlfy:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id,'started')
send(msg_chat_id,msg_id,'⇜ ارسل الصوت ليتم حفضه باسم : '..text)
return false
end
if Redis:get(Thealhlfy.."alhlfy:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id) == 'started' then
if msg.content.audio then  
local nameaudio = Redis:get(Thealhlfy..'alhlfy:Text:Games:audio'..msg.chat_id)
Redis:set(Thealhlfy.."alhlfy:audio:Games"..msg.chat_id..nameaudio,msg.content.audio.audio.remote.id)  
Redis:del(Thealhlfy.."alhlfy:Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
send(msg_chat_id,msg_id,'⇜ تم حفظ الصوت باسم : '..nameaudio)
return false
end   
end
if text and not Redis:get(Thealhlfy..'lock_geamsAudio1'..msg.chat_id) then
local nameaudio = Redis:get(Thealhlfy.."alhlfy:audio:Games"..msg.chat_id..text)
if nameaudio then
bot.sendAudio(msg_chat_id, msg.id,nameaudio , '', "md") 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Thealhlfy.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "truedel" then
Redis:set(Thealhlfy.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"truefguigf1")
Redis:del(Thealhlfy.."gamebot:newqus"..msg.chat_id,text)
Redis:srem(Thealhlfy.."gamebot:new1", text)
return send(msg_chat_id,msg_id, '\nتم مسح السؤال') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Thealhlfy.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true" then
Redis:set(Thealhlfy.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true1")
Redis:set(Thealhlfy.."gamebot:newqus"..msg.chat_id,text)
Redis:sadd(Thealhlfy.."gamebot:new1", text)
return send(msg_chat_id,msg_id, '\n⇜ تم حفظ السؤال \n⇜ ارسل الجواب الاول') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Thealhlfy.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true1" then
local quschen = Redis:get(Thealhlfy.."gamebot:newqus"..msg.chat_id)
Redis:set(Thealhlfy.."gamebot:newqus:as1"..quschen,text)
Redis:set(Thealhlfy.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true2")
return send(msg_chat_id,msg_id, ' \n⇜ ارسل الجواب الثاني') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Thealhlfy.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true2" then
local quschen = Redis:get(Thealhlfy.."gamebot:newqus"..msg.chat_id)
Redis:set(Thealhlfy.."gamebot:newqus:as2"..quschen,text)
Redis:set(Thealhlfy.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true3")
return send(msg_chat_id,msg_id, '\n⇜ ارسل الجواب الثالث') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Thealhlfy.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true3" then
local quschen = Redis:get(Thealhlfy.."gamebot:newqus"..msg.chat_id)
Redis:set(Thealhlfy.."gamebot:newqus:as3"..quschen,text)
Redis:set(Thealhlfy.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true4")
return send(msg_chat_id,msg_id, '\n⇜ ارسل الجواب الرابع') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Thealhlfy.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true4" then
local quschen = Redis:get(Thealhlfy.."gamebot:newqus"..msg.chat_id)
Redis:set(Thealhlfy.."gamebot:newqus:as0"..quschen,text)
Redis:set(Thealhlfy.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true44")
return send(msg_chat_id,msg_id, '\n⇜ تم حفظ الاجوبة \n⇜ ارسل الجواب الصحيح') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Thealhlfy.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true44" then
local quschen = Redis:get(Thealhlfy.."gamebot:newqus"..msg.chat_id)
Redis:set(Thealhlfy.."gamebot:newqus:as4"..quschen,text)
Redis:set(Thealhlfy.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true186")
return send(msg_chat_id,msg_id, '\n⇜ تم حفظ الجواب الصحيح') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Thealhlfy.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "truedel" then
send(msg_chat_id,msg_id, '\n⇜ تم مسح الغز ')
Redis:set(Thealhlfy.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"truefguigf1")
Redis:del(Thealhlfy.."lkz:gamebot:newqus"..msg.chat_id,text)
Redis:srem(Thealhlfy.."lkz:gamebot:new1", text)
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Thealhlfy.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true" then
send(msg_chat_id,msg_id, '\n⇜ تم حفظ اللغز \n⇜ ارسل الجواب الاول')
Redis:set(Thealhlfy.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true1")
Redis:set(Thealhlfy.."lkz:gamebot:newqus"..msg.chat_id,text)
Redis:sadd(Thealhlfy.."lkz:gamebot:new1", text)
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Thealhlfy.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true1" then
send(msg_chat_id,msg_id, ' \n⇜ ارسل الجواب الثاني')
local quschen = Redis:get(Thealhlfy.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(Thealhlfy.."lkz:gamebot:newqus:as1"..quschen,text)
Redis:set(Thealhlfy.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true2")
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Thealhlfy.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true2" then
send(msg_chat_id,msg_id, '\n⇜ ارسل الجواب الثالث')
local quschen = Redis:get(Thealhlfy.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(Thealhlfy.."lkz:gamebot:newqus:as2"..quschen,text)
Redis:set(Thealhlfy.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true3")
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Thealhlfy.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true3" then
send(msg_chat_id,msg_id, ' \n⇜ ارسل الجواب الصحيح')
local quschen = Redis:get(Thealhlfy.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(Thealhlfy.."lkz:gamebot:newqus:as3"..quschen,text)
Redis:set(Thealhlfy.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true44")
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Thealhlfy.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id) == "true44" then
send(msg_chat_id,msg_id, '\n⇜ تم حفظ الجواب الصحيح')
local quschen = Redis:get(Thealhlfy.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(Thealhlfy.."lkz:gamebot:newqus:as4"..quschen,text)
Redis:set(Thealhlfy.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,"true186")
return false 
end
end
if Redis:get(Thealhlfy..":"..msg.sender_id.user_id..":lov_Bots"..msg.chat_id) == "sendlove" then
...
Redis:del(Thealhlfy..":"..msg.sender_id.user_id..":lov_Bots"..msg.chat_id)
end
if Redis:get(Thealhlfy..":"..msg.sender_id.user_id..":lov_Bottts"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⇜ نسبة الغباء : '..text..' '..sendnum..'%'
send(msg_chat_id,msg_id,tttttt) 
Redis:del(Thealhlfy..":"..msg.sender_id.user_id..":lov_Bottts"..msg.chat_id)
end
if Redis:get(Thealhlfy..":"..msg.sender_id.user_id..":lov_Botttuus"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⇜ نسبة الذكاء : '..text..' '..sendnum..'%'
send(msg_chat_id,msg_id,tttttt) 
Redis:del(Thealhlfy..":"..msg.sender_id.user_id..":lov_Botttuus"..msg.chat_id)
end
if text and Redis:get(Thealhlfy..":"..msg.sender_id.user_id..":krh_Bots"..msg.chat_id) == "sendkrhe" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⇜ نسبه الكره : '..text..' '..sendnum..'%'
send(msg_chat_id,msg_id,tttttt) 
Redis:del(Thealhlfy..":"..msg.sender_id.user_id..":krh_Bots"..msg.chat_id)
end
if text and text ~="نسبه الرجوله" and Redis:get(Thealhlfy..":"..msg.sender_id.user_id..":rjo_Bots"..msg.chat_id) == "sendrjoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","🥰 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '⇜ نسبة الرجوله : '..text..' '..sendnuj..'%'
send(msg_chat_id,msg_id,tttttt) 
Redis:del(Thealhlfy..":"..msg.sender_id.user_id..":rjo_Bots"..msg.chat_id)
end
if text and text ~="نسبه الانوثه" and Redis:get(Thealhlfy..":"..msg.sender_id.user_id..":ano_Bots"..msg.chat_id) == "sendanoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","?? 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '⇜ نسبه الانوثة : '..text..' '..sendnuj..'%'
send(msg_chat_id,msg_id,tttttt) 
Redis:del(Thealhlfy..":"..msg.sender_id.user_id..":ano_Bots"..msg.chat_id)
end
if Redis:get(Thealhlfy.."alhlfy:Game:Arbieq"..msg.chat_id) then
if text == Redis:get(Thealhlfy.."alhlfy:Game:Arbieq"..msg.chat_id) then 
Redis:del(Thealhlfy.."alhlfy:Game:Arbieq"..msg.chat_id)
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
...
---------------------- عقـــاب ----------------------
if Redis:get(Thealhlfy.."Start_Ahkamm"..msg.chat_id) then
if text == "انا" then
if Redis:sismember(Thealhlfy..'List_Ahkamm'..msg.chat_id,msg.sender_id.user_id) then
return bot.sendText(msg.chat_id,msg.id,'⇜ اسمك موجود من قبل',"md",true)
end
Redis:sadd(Thealhlfy..'members_Ahkamm'..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(Thealhlfy..'List_Ahkamm'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(Thealhlfy.."Witting_StartGamehh"..msg.chat_id,1400,true)
...
---------------------- احكـــام ----------------------
if text == "انا" and Redis:get(Thealhlfy.."Start_Ahkkam"..msg.chat_id) then
if Redis:sismember(Thealhlfy..'List_Ahkkam'..msg.chat_id,msg.sender_id.user_id) then
return bot.sendText(msg.chat_id,msg.id,'⇜ اسمك موجود من قبل',"md",true)
end
Redis:sadd(Thealhlfy..'List_Ahkkam'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(Thealhlfy.."Witting_StartGameh"..msg.chat_id,1400,true)
local list = Redis:smembers(Thealhlfy..'List_Ahkkam'..msg.chat_id) 
if #list == 2 then
...
---------------------- كرســـي الاعتـــراف ----------------------
if text == "انا" and Redis:get(Thealhlfy.."Start_Koorsi"..msg.chat_id) then
if Redis:sismember(Thealhlfy..'List_Koorsi'..msg.chat_id,msg.sender_id.user_id) then
return bot.sendText(msg.chat_id,msg.id,'⇜ اسمك موجود من قبل',"md",true)
end
Redis:sadd(Thealhlfy..'List_Koorsi'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(Thealhlfy.."Witting_StartGameek"..msg.chat_id,1400,true)
local list = Redis:smembers(Thealhlfy..'List_Koorsi'..msg.chat_id) 
if #list == 2 then
local UserInfo = bot.getUser(msg.sender_id.user_id)
local Teext = '- ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..msg.sender_id.user_id..')'
local zzllzz = '⇜ عدد الاعبين : '..#list..' \n⇜ انضم للعبة \n'..Teext
...
if Redis:get(Thealhlfy.."alhlfy:Game:Arbieq:aslame"..msg.chat_id) then
if text == Redis:get(Thealhlfy.."alhlfy:Game:Arbieq:aslame"..msg.chat_id) then 
Redis:del(Thealhlfy.."alhlfy:Game:Arbieq:aslame"..msg.chat_id)
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
end
if Redis:get(Thealhlfy.."alhlfy:Game:Arbieq:aslamek"..msg.chat_id) then
if text == Redis:get(Thealhlfy.."alhlfy:Game:Arbieq:aslamek"..msg.chat_id) then 
Redis:del(Thealhlfy.."alhlfy:Game:Arbieq:aslamek"..msg.chat_id)
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
end
if Redis:get(Thealhlfy.."alhlfy:Game:Monotonousss"..msg.chat_id) then
if text == Redis:get(Thealhlfy.."alhlfy:Game:Monotonousss"..msg.chat_id) then 
Redis:del(Thealhlfy.."alhlfy:Game:Monotonousss"..msg.chat_id)
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
...
if Redis:get(Thealhlfy.."mshaher"..msg.chat_id) then
if text == Redis:get(Thealhlfy.."mshaher"..msg.chat_id) then
Redis:del(Thealhlfy.."mshaher"..msg.chat_id)
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true)  
end
end 
if Redis:get(Thealhlfy.."mshaherr"..msg.chat_id) then
if text == Redis:get(Thealhlfy.."mshaherr"..msg.chat_id) then
Redis:del(Thealhlfy.."mshaherr"..msg.chat_id)
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true)  
end
end
if Redis:get(Thealhlfy.."mshaherrr"..msg.chat_id) then
if text == Redis:get(Thealhlfy.."mshaherrr"..msg.chat_id) then
Redis:del(Thealhlfy.."mshaherrr"..msg.chat_id)
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true)  
end
end  
if Redis:get(Thealhlfy.."photohzr"..msg.chat_id) then
if text == Redis:get(Thealhlfy.."photohzr"..msg.chat_id) then
Redis:del(Thealhlfy.."photohzr"..msg.chat_id)
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true)  
end
...
if Redis:get(Thealhlfy.."Start_rhan"..msg.chat_id) then
...
if Redis:sismember(Thealhlfy..'List_rhan'..msg.chat_id,msg.sender_id.user_id) then
...
Redis:setex(Thealhlfy.."Witting_Startrhan"..msg.chat_id,1400,true)
benrahan = Redis:get(Thealhlfy.."allrhan"..msg.chat_id..12345) or 0
rehan = tonumber(benrahan) + tonumber(coniss)
Redis:set(Thealhlfy.."allrhan"..msg.chat_id..12345 , rehan)
...
if text == "حظي" then
if Redis:get(Thealhlfy.."alhlfy:Status:Games:malk"..msg.chat_id) then
return false 
end
if not Redis:get(Thealhlfy.."alhlfy:Status:Games"..msg.chat_id) then
return false
end
local list = {"3","5","-3","-5","="}
RtList = list[math.random(#list)]
if RtList == "3" then
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id,3)
StatusRt = "الف مبروك حظك حلو ربحت 3 نقاط"
elseif RtList == "5" then
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id,5)
StatusRt = "الف مبروك حظك حلو ربحت 5 نقاط"
elseif RtList == "-3" then
Redis:decrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id,3)  
StatusRt = "للاسف حظك زفت خسرت 3 نقاط"
elseif RtList == "-5" then
Redis:decrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id,5)  
...
Redis:set(Thealhlfy.."alhlfy:Game:Arbieq"..msg.chat_id,name)
return false
end
...
Redis:set(Thealhlfy.."alhlfy:Game:Arbieq:aslame"..msg.chat_id,name)
return false
end
if text == "اية" then
if Redis:get(Thealhlfy.."alhlfy:Status:Games:malk"..msg.chat_id) then
...
Redis:set(Thealhlfy.."alhlfy:Game:Arbieq:aslamek"..msg.chat_id,name)
return false
end
...
Redis:set(Thealhlfy.."alhlfy:Game:Monotonousss"..msg.chat_id,name)
return false
end
if text == "حجره" then
if Redis:get(Thealhlfy.."alhlfy:Status:Games:malk"..msg.chat_id) then
...
local Bot_Name = (Redis:get(Thealhlfy.."alhlfy:Name:Bot") or "لويس")
if not Redis:get(Thealhlfy.."alhlfy:Status:repleall") then
if text == 'صباح الخير' or text == 'صباحو' or text =='صباح النور' then
if Redis:get(Thealhlfy.."replayallbot"..msg.chat_id) then
local NamecBots = {
'صباح الياسمين',
'صباح النور',
...
if text== "الابراج"  or text== "ابراج"  and Redis:get(Thealhlfy..'replayallbot'..msg.chat_id) then
return send(msg.chat_id,msg.id,"ٰ⇜ اكتب : برج + اسم برجك ")
end
if text== "همسه"  or text== "همسة"  and Redis:get(Thealhlfy..'replayallbot'..msg.chat_id) then
return send(msg.chat_id,msg.id,"⇜ اهلا بك عزيزي\n⇜ اكتب معرف البوت ثم الرساله ثم معرف الشخص\n⇜ مثال\n[@rigbot] مرحبا [@DevZaid]")
end
if text== "تحويل الصيغ" and Redis:get(Thealhlfy..'replayallbot'..msg.chat_id) then
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
if ChannelJoin(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Channel:Join:Name'), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Channel:Join')}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
if not msg.DevelopersQ then 
return send(msg_chat_id,msg_id,'\n⇜ هذا الامر يخص ( '..Controller_Num(2)..' ) ',"md",true)  
end
Redis:set(Thealhlfy.."gamebot:Set:Manager:rd"..msg.sender_id.user_id..":"..msg.chat_id,true)
...
Redis:set(Thealhlfy.."gamebot:Set:Manager:rdd"..msg.sender_id.user_id..":"..msg.chat_id,true)
...
if Redis:get(Thealhlfy.."alhlfy:Status:Games"..msg.chat_id) then 
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local list = Redis:smembers(Thealhlfy.."gamebot:List:Manager")
if #list ~= 0 then
...
for k,v in pairs(list) do
Redis:sadd(Thealhlfy.."gamebot:List:Manager",v)
end
...
Redis:sadd(Thealhlfy.."Black:listBan:",Chatid)
...
Redis:srem(Thealhlfy.."Black:listBan:",Chatid)
...
Redis:del(Thealhlfy..'rolet:list'..msg.chat_id) 
...
Redis:del(Thealhlfy..'loce:list'..msg.chat_id) 
send(msg_chat_id,msg_id,xxffxx,"md",false, false, false, false, reply_markup)
end
end
...
Redis:set(Thealhlfy.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,true)
...
Redis:set(Thealhlfy.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,'truedel')
return send(msg_chat_id,msg_id,"⇜ ارسل السؤال الان ")
end
...
local list = Redis:smembers(Thealhlfy.."gamebot:new1")
...
Redis:del(Thealhlfy.."gamebot:new1")
...
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(Thealhlfy.."alhlfy:Game:alam"..msg.chat_id,name)
...
Redis:set(Thealhlfy.."alhlfy:Game:ausm"..msg.chat_id,name)
return false
end
end
if Redis:get(Thealhlfy.."alhlfy:Game:klmaa"..msg.chat_id) then
if text == Redis:get(Thealhlfy.."alhlfy:Game:klmaa"..msg.chat_id) then
Redis:del(Thealhlfy.."alhlfy:Game:klmaa"..msg.chat_id)
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)  
local Num = Redis:get(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
...
Redis:set(Thealhlfy.."alhlfy:Game:klmaa"..msg.chat_id,name)
return false
end
end
...
Redis:del(Thealhlfy..'List_Ahkamm'..msg.chat_id)
Redis:del(Thealhlfy..'members_Ahkamm'..msg.chat_id) 
Redis:set(Thealhlfy.."raeahkamm"..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(Thealhlfy..'List_Ahkamm'..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(Thealhlfy..'members_Ahkamm'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(Thealhlfy.."Start_Ahkamm"..msg.chat_id,3600,true)
...
local list = Redis:smembers(Thealhlfy..'List_Ahkamm'..msg.chat_id) 
...
if text == 'نعم' and Redis:get(Thealhlfy.."Witting_StartGamehh"..msg.chat_id) then
rarahkam = Redis:get(Thealhlfy.."raeahkamm"..msg.chat_id)
...
Redis:sadd(Thealhlfy.."kk_Akab"..msg.chat_id,UserId_Info.id)
Redis:srem(Thealhlfy..'members_Ahkamm'..msg_chat_id,UserId_Info.id) 
local GetLike = Redis:incrby(Thealhlfy.."Num:Add:Akab"..msg.chat_id..UserId_Info.id, 1) 
Redis:hset(Thealhlfy..':GroupUserCountAkab:'..msg.chat_id,UserId_Info.id,GetLike)
...
NameLUser = NameLUser:gsub("[[]","")
Redis:hset(Thealhlfy..':GroupAkabNameUser:'..msg.chat_id,UserId_Info.id,NameLUser)
Redis:del(Thealhlfy..'raeahkamm'..msg.chat_id) 
Redis:del(Thealhlfy..'List_Ahkamm'..msg.chat_id) 
Redis:del(Thealhlfy.."Witting_StartGamehh"..msg.chat_id)
Redis:del(Thealhlfy.."Start_Ahkamm"..msg.chat_id)
katu = {
...
Redis:del(Thealhlfy..'List_Ahkkam'..msg.chat_id)
Redis:set(Thealhlfy.."raeahkkam"..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(Thealhlfy..'List_Ahkkam'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(Thealhlfy.."Start_Ahkkam"..msg.chat_id,3600,true)
...
local Quuiz = Redis:get(Thealhlfy.."Quiz:Add:Koorsy"..msg.chat_id) or 0
...
Redis:del(Thealhlfy..'List_Koorsi'..msg.chat_id)
Redis:del(Thealhlfy.."Quiz:Add:Koorsy"..msg.chat_id)
Redis:set(Thealhlfy.."raekoorsi"..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(Thealhlfy..'List_Koorsi'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(Thealhlfy.."Start_Koorsi"..msg.chat_id,3600,true)
bot.sendText(msg_chat_id,msg_id,zzllzz,"md",false, false, false, false, reply_markup)
end
----------------------------------------
...
local Qiuiz = Redis:get(Thealhlfy.."Quiz:Add:Saraha"..msg.chat_id) or 0
...
Redis:del(Thealhlfy..'List_Saraha'..msg.chat_id)
Redis:del(Thealhlfy.."Quiz:Add:Saraha"..msg.chat_id)
Redis:set(Thealhlfy.."raesaraha"..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(Thealhlfy..'List_Saraha'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(Thealhlfy.."Start_Saraha"..msg.chat_id,3600,true)
bot.sendText(msg_chat_id,msg_id,zzllzz,"md",false, false, false, false, reply_markup)
end
----------------------------------
...
if not Redis:get(Thealhlfy.."Status:Aktmooh"..msg.chat_id) then
...
Redis:set(Thealhlfy.."Ak_Tmooh"..msg.chat_id,Message_Reply.sender_id.user_id)
Redis:del(Thealhlfy..'List_Aktooh'..msg.chat_id)
Redis:set(Thealhlfy.."raeaktooh"..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(Thealhlfy..'List_Aktooh'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(Thealhlfy.."Start_Aktmooh"..msg.chat_id,3600,true)
bot.sendText(msg_chat_id,msg_id,zzllzz,"md",false, false, false, false, reply_markup)
end
...
Redis:set(Thealhlfy.."makal:bots:set"..msg.sender_id.user_id..":"..msg.chat_id,true)
return send(msg_chat_id,msg_id,"⇜ ارسل السؤال الان ")
end
...
Redis:set(Thealhlfy.."makal:bots:del"..msg.sender_id.user_id..":"..msg.chat_id,true)
...
Redis:del(Thealhlfy.."makal:bots")
return send(msg_chat_id,msg_id,"⇜ تم مسح الجمل")
end
if text and text:match("^(.*)$") then
if Redis:get(Thealhlfy.."makal:bots:del"..msg.sender_id.user_id..":"..msg.chat_id) == "true" then
Redis:set(Thealhlfy.."makal:bots:del"..msg.sender_id.user_id..":"..msg.chat_id,"true1uu")
Redis:srem(Thealhlfy.."makal:bots", text)
return send(msg_chat_id,msg_id, '\n⇜ تم مسح السؤال')
end
end
if text and text:match("^(.*)$") then
if Redis:get(Thealhlfy.."makal:bots:set"..msg.sender_id.user_id..":"..msg.chat_id) == "true" then
Redis:set(Thealhlfy.."makal:bots:set"..msg.sender_id.user_id..":"..msg.chat_id,"true1uu")
Redis:sadd(Thealhlfy.."makal:bots", text)
return send(msg_chat_id,msg_id, '\n⇜ تم حفظ السؤال ')
end
end
if text == 'جمل' then
...
Redis:set(Thealhlfy.."makal:bots:qus"..msg.chat_id,quschen1)
Redis:setex(Thealhlfy.."mkal:setex:" .. msg.chat_id .. ":" .. msg.sender_id.user_id, 60, true) 
end
end
end
if text == ""..(Redis:get(Thealhlfy.."makal:bots:qus"..msg.chat_id) or '').."" then
local timemkall = Redis:ttl(Thealhlfy.."mkal:setex:" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
...
Redis:del(Thealhlfy.."makal:bots:qus"..msg.sender_id.user_id..":"..msg.chat_id)
Redis:del(Thealhlfy.."mkal:setex:" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
end
if text =="صراحه" then
if Redis:get(Thealhlfy.."alhlfy:Status:Games:malk"..msg.chat_id) then
return false 
...
if not Redis:get(Thealhlfy..'lock_geams'..msg.chat_id) then
local list = Redis:smembers(Thealhlfy.."gamebot:new1")
if #list ~= 0 then
local quschen = list[math.random(#list)]
local ansar1 = Redis:get(Thealhlfy.."gamebot:newqus:as1"..quschen)
local ansar2 = Redis:get(Thealhlfy.."gamebot:newqus:as2"..quschen)
local ansar3 = Redis:get(Thealhlfy.."gamebot:newqus:as3"..quschen)
local ansar0 = Redis:get(Thealhlfy.."gamebot:newqus:as0"..quschen)
local ansar4 = Redis:get(Thealhlfy.."gamebot:newqus:as4"..quschen)
...
Redis:set(Thealhlfy.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,true)
...
Redis:set(Thealhlfy.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,'truedel')
return send(msg_chat_id,msg_id,"⇜ ارسل اللغز الان ")
end
...
local list = Redis:smembers(Thealhlfy.."lkz:gamebot:new1")
t = "⇜ الالغاز : \n"
for k,v in pairs(list) do
t = t..""..k.."- "..v.."\n"
end
...
Redis:del(Thealhlfy.."lkz:gamebot:new1")
...
if #list ~= 0 then
local quschen = list[math.random(#list)]
local ansar1 = Redis:get(Thealhlfy.."lkz:gamebot:newqus:as1"..quschen)
local ansar2 = Redis:get(Thealhlfy.."lkz:gamebot:newqus:as2"..quschen)
local ansar3 = Redis:get(Thealhlfy.."lkz:gamebot:newqus:as3"..quschen)
local ansar4 = Redis:get(Thealhlfy.."lkz:gamebot:newqus:as4"..quschen)
if ansar1 == ansar4 then
tt = 'ansar1'
elseif ansar2 == ansar4 then
tt = 'ansar2'
...
Redis:del(Thealhlfy.."gamebot:List:Manager")
...
local numtsh = Redis:scard(Thealhlfy..'alhlfy:tahaath'..msg.chat_id)
if numtsh ==0 then  
return send(msg_chat_id,msg_id, "⇜ مافي كيكات" )
end
Redis:del(Thealhlfy..'alhlfy:tahaath'..msg.chat_id)
...
local numtsh = Redis:scard(Thealhlfy..'alhlfy:klp'..msg.chat_id)
if numtsh ==0 then  
return send(msg_chat_id,msg_id, "⇜ مافي عسلات" )
end
Redis:del(Thealhlfy..'alhlfy:klp'..msg.chat_id)
...
local numtsh = Redis:scard(Thealhlfy..'alhlfy:donke'..msg.chat_id)
if numtsh ==0 then  
return send(msg_chat_id,msg_id, "⇜ مافي زقات" )
end
Redis:del(Thealhlfy..'alhlfy:donke'..msg.chat_id)
...
local numtsh = Redis:scard(Thealhlfy..'alhlfy:zahf'..msg.chat_id)
if numtsh ==0 then  
return send(msg_chat_id,msg_id, "⇜ مافي حمير" )
end
Redis:del(Thealhlfy..'alhlfy:zahf'..msg.chat_id)
...
local numtsh = Redis:scard(Thealhlfy..'alhlfy:sakl'..msg.chat_id)
if numtsh ==0 then  
return send(msg_chat_id,msg_id, "⇜ مافي بقر" )
end
Redis:del(Thealhlfy..'alhlfy:sakl'..msg.chat_id)
...
local numtsh = Redis:scard(Thealhlfy..'alhlfy:klpe'..msg.chat_id)
if numtsh ==0 then  
return send(msg_chat_id,msg_id, "⇜ مافي احد بقلبك" )
end
Redis:del(Thealhlfy..'alhlfy:klpe'..msg.chat_id)
...
local numtsh = Redis:scard(Thealhlfy..'alhlfy:tagge'..msg.chat_id)
if numtsh ==0 then  
return send(msg_chat_id,msg_id, "⇜ مافي كلاب" )
end
Redis:del(Thealhlfy..'alhlfy:tagge'..msg.chat_id)
...
local numtsh = Redis:scard(Thealhlfy..'alhlfy:mrtee'..msg.chat_id)
if numtsh ==0 then  
return send(msg_chat_id,msg_id, "⇜ مافي هطوف" )
end
Redis:del(Thealhlfy..'alhlfy:mrtee'..msg.chat_id)
...
local numtsh = Redis:scard(Thealhlfy..'alhlfy:loke'..msg.chat_id)
if numtsh ==0 then  
return send(msg_chat_id,msg_id, "⇜ مافي قرود" )
end
Redis:del(Thealhlfy..'alhlfy:loke'..msg.chat_id)
...
local numtsh = Redis:scard(Thealhlfy..'alhlfy:stope'..msg.chat_id)
if numtsh ==0 then  
return send(msg_chat_id,msg_id, "⇜ مافي خرفان" )
end
Redis:del(Thealhlfy..'alhlfy:stope'..msg.chat_id)
...
if not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
Redis:set(Thealhlfy..":"..msg.sender_id.user_id..":lov_Bots"..msg.chat_id,"sendlove")
...
if not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
Redis:set(Thealhlfy..":"..msg.sender_id.user_id..":lov_Bottts"..msg.chat_id,"sendlove")
...
if not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
Redis:set(Thealhlfy..":"..msg.sender_id.user_id..":lov_Botttuus"..msg.chat_id,"sendlove")
hggg = '⇜ الان ارسل اسم الشخص '
send(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
Redis:set(Thealhlfy..":"..msg.sender_id.user_id..":krh_Bots"..msg.chat_id,"sendkrhe")
hggg = '⇜ الان ارسل اسمك واسم الشخص الثاني '
send(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
Redis:set(Thealhlfy..":"..msg.sender_id.user_id..":rjo_Bots"..msg.chat_id,"sendrjoe")
hggg = '⇜ الان ارسل اسم الشخص '
send(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
Redis:set(Thealhlfy..":"..msg.sender_id.user_id..":ano_Bots"..msg.chat_id,"sendanoe")
hggg = '⇜ الان ارسل اسم الشخص '
send(msg_chat_id,msg_id,hggg) 
return false
end
end
if text== "رفع كيكه" and msg.reply_to_message_id and not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(Thealhlfy.."alhlfy:tahaath"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته كيكه 🍰\n✧️")
elseif text== "تنزيل كيكه" and msg.reply_to_message_id and not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(Thealhlfy.."alhlfy:tahaath"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر نزلته من كيكه\n✧")
elseif text== "رفع عسل" and msg.reply_to_message_id and not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(Thealhlfy.."alhlfy:klp"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته عسل 🍯\n✧")
elseif text== "رفع زق"  and msg.reply_to_message_id and not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(Thealhlfy.."alhlfy:donke"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته زق 💩\n✧️")
elseif text== "تنزيل زق"  and msg.reply_to_message_id and not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(Thealhlfy.."alhlfy:donke"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر نزلته من زق\n✧️")
elseif text== "تنزيل عسل"  and msg.reply_to_message_id and not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(Thealhlfy.."alhlfy:klp"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر نزلته من عسل\n✧️")
elseif text== "تنزيل حمار"  and msg.reply_to_message_id and not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(Thealhlfy.."alhlfy:zahf"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته حمار\n✧️")
elseif text== "رفع حمار"  and msg.reply_to_message_id and not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(Thealhlfy.."alhlfy:zahf"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته حمار 🦓\n✧️")
elseif text== "رفع بقره" or text== "رفع بقرة" and msg.reply_to_message_id and not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(Thealhlfy.."alhlfy:sakl"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته بقره 🐄\n✧")
elseif text== "تنزيل بقره" or text== "تنزيل بقرة" and msg.reply_to_message_id and not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(Thealhlfy.."alhlfy:sakl"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر نزلته من بقرة\n✧️")
elseif text== "رفع بقلبي" or text== "رفع لقلبي" and msg.reply_to_message_id and not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(Thealhlfy.."alhlfy:klpe"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته لقلبك ❤️\n✧️")
elseif text== "تنزيل من قلبي"  and msg.reply_to_message_id and not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then  
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(Thealhlfy.."alhlfy:klpe"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر نزلته من قلبك\n✧")
elseif text== "رفع كلب"  and msg.reply_to_message_id and not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(Thealhlfy.."alhlfy:tagge"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته كلب 🐩️ \n✧️")
elseif text== "تنزيل كلب"  and msg.reply_to_message_id and not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(Thealhlfy.."alhlfy:tagge"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر نزلته من كلب\n✧")
elseif text== "رفع هطف" and msg.reply_to_message_id and not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(Thealhlfy.."alhlfy:mrtee"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته هطف 🧱\n✧")
elseif text== "تنزيل هطف"  and msg.reply_to_message_id and not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(Thealhlfy.."alhlfy:mrtee"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر نزلته من هطف\n✧")
elseif text== "رفع قرد" and msg.reply_to_message_id and not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(Thealhlfy.."alhlfy:loke"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته قرد 🐒\n✧️")
elseif text== "تنزيل قرد" and msg.reply_to_message_id and not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(Thealhlfy.."alhlfy:loke"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر نزلته من قرد\n✧")
elseif text== "رفع خروف" and msg.reply_to_message_id and not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:sadd(Thealhlfy.."alhlfy:stope"..msg.chat_id, Message_Reply.sender_id.user_id)
return send(msg_chat_id,msg_id,"⇜ ابشر رفعته خاروف 🐏\n✧️")
elseif text== "تنزيل خاروف" and msg.reply_to_message_id and not Redis:get(Thealhlfy.."trfeh"..msg.chat_id) then  
  if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Thealhlfy..'alhlfy:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
Redis:srem(Thealhlfy.."alhlfy:stope"..msg.chat_id, Message_Reply.sender_id.user_id)
...
local list = Redis:smembers(Thealhlfy.."alhlfy:tahaath"..msg.chat_id)
...
local list = Redis:smembers(Thealhlfy.."alhlfy:klp"..msg.chat_id)
...
local list = Redis:smembers(Thealhlfy.."alhlfy:donke"..msg.chat_id)
...
local list = Redis:smembers(Thealhlfy.."alhlfy:zahf"..msg.chat_id)
...
local list = Redis:smembers(Thealhlfy.."alhlfy:sakl"..msg.chat_id)
...
local list = Redis:smembers(Thealhlfy.."alhlfy:klpe"..msg.chat_id)
...
local list = Redis:smembers(Thealhlfy.."alhlfy:tagge"..msg.chat_id)
...
local list = Redis:smembers(Thealhlfy.."alhlfy:mrtee"..msg.chat_id)
...
local list = Redis:smembers(Thealhlfy.."alhlfy:loke"..msg.chat_id)
...
local list = Redis:smembers(Thealhlfy.."alhlfy:stope"..msg.chat_id)
...
if not Redis:get(Thealhlfy.."alhlfy:Alzwag:Chat"..msg_chat_id) then
...
if tonumber(member_id) == tonumber(msg.sender_id.user_id) or tonumber(member_id) == tonumber(Thealhlfy) or bot.getUser(member_id).type.luatele == "userTypeBot" or Redis:get(Thealhlfy..msg_chat_id..member_id.."mtzwga:") then 
return send(msg_chat_id,msg_id,"⇜ اسف ياحلو مو وقت زواج الحين","md")
end
if Redis:get(Thealhlfy..msg_chat_id..msg.sender_id.user_id.."mtzwga:") then
    local zwg_id =  Redis:get(Thealhlfy..msg_chat_id..msg.sender_id.user_id.."mtzwga:")
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if tonumber(Redis:get(Thealhlfy..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:")) == tonumber(msg.sender_id.user_id) or tonumber(Redis:get(Thealhlfy..msg_chat_id..msg.sender_id.user_id.."mtzwga:")) == tonumber(Message_Reply.sender_id.user_id) then
...
elseif tonumber(Message_Reply.sender_id.user_id) == tonumber(Thealhlfy) then
  return send(msg_chat_id,msg_id,"⇜ هييه مايمديك تتزوجني\n✧","md")
elseif Redis:get(Thealhlfy..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:") then
local zwg_id =  Redis:get(Thealhlfy..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:")
local zwg_info = bot.getUser(zwg_id)
return send(msg_chat_id,msg_id,"⇜ وينك ياوحش\n["..zwg_info.first_name.."](tg://user?id="..zwg_id..")\n⇜ يبون يتزوجو زوجتك ","md")
elseif Redis:get(Thealhlfy..msg_chat_id..msg.sender_id.user_id.."mtzwga:") then
  local zwg_id =  Redis:get(Thealhlfy..msg_chat_id..msg.sender_id.user_id.."mtzwga:")
  local zwg_info = bot.getUser(zwg_id)
  return send(msg_chat_id,msg_id,"⇜ الحين اناديها انتظر\n["..zwg_info.first_name.."](tg://user?id="..zwg_id..")\n⇜ يبي يتزوج عليك هههه","md")
elseif not Redis:get(Thealhlfy..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:")  then
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if text == "زوجتي" then
  if Redis:get(Thealhlfy..msg_chat_id..msg.sender_id.user_id.."mtzwga:") then
    local zwga_id = Redis:get(Thealhlfy..msg_chat_id..msg.sender_id.user_id.."mtzwga:")
  ...
  elseif not Redis:get(Thealhlfy..msg_chat_id..msg.sender_id.user_id.."mtzwga:") then
...
elseif tonumber(Redis:get(Thealhlfy..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:")) ~= tonumber(msg.sender_id.user_id) or tonumber(Redis:get(Thealhlfy..msg_chat_id..msg.sender_id.user_id.."mtzwga:")) ~= tonumber(Message_Reply.sender_id.user_id) then
  return send(msg_chat_id,msg_id,"⇜ هييه مايمديك تطلقها لان مو زوجتك\n✧","md")
elseif tonumber(Redis:get(Thealhlfy..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:")) == tonumber(msg.sender_id.user_id) or tonumber(Redis:get(Thealhlfy..msg_chat_id..msg.sender_id.user_id.."mtzwga:")) == tonumber(Message_Reply.sender_id.user_id) then
    Redis:del(Thealhlfy..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:")
    Redis:del(Thealhlfy..msg_chat_id..msg.sender_id.user_id.."mtzwga:")
...
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(Thealhlfy.."mshaher"..msg.chat_id,name)
...
Redis:set(Thealhlfy.."mshaherr"..msg.chat_id,name)
...
Redis:set(Thealhlfy.."mshaherrr"..msg.chat_id,name)
...
name = KlamSpeeddd[math.random(#KlamSpeeddd)]
Redis:set(Thealhlfy.."photohzr"..msg.chat_id,name)
...
Redis:setex(Thealhlfy.."Status:aktbassend"..msg.chat_id,120,true) 
return send(msg_chat_id,msg_id,'\n⇜ ارسل لي الاقتباس\n- يسمح لك :\n( ملصق + صورة + نص + فيديو + صوت )',"md",true)  
end
if Redis:get(Thealhlfy..'Status:aktbassend'..msg.chat_id) then
Redis:del(Thealhlfy..'Status:aktbassend'..msg.chat_id)
Redis:del(Thealhlfy..'Status:aktbasrdstic'..msg.chat_id)
Redis:del(Thealhlfy..'Status:aktbasrdtext'..msg.chat_id)
Redis:del(Thealhlfy..'Status:aktbasrdaudio'..msg.chat_id)
Redis:del(Thealhlfy..'Status:aktbasrdanim'..msg.chat_id)
Redis:del(Thealhlfy..'Status:aktbasrdvid'..msg.chat_id)
Redis:del(Thealhlfy..'Status:aktbasrdphoto'..msg.chat_id)
if msg.content.sticker then   
Redis:set(Thealhlfy.."Status:aktbasrdstic"..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Thealhlfy.."Status:aktbasrdtext"..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(Thealhlfy.."Status:aktbasrdaudio"..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.animation then
Redis:set(Thealhlfy.."Status:aktbasrdanim"..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video then
Redis:set(Thealhlfy.."Status:aktbasrdvid"..msg_chat_id, msg.content.video.video.remote.id)  
end
...
Redis:set(Thealhlfy.."Status:aktbasrdphoto"..msg_chat_id, idPhoto)  
end
...
Redis:del(Thealhlfy..'Status:Reply'..msg.chat_id)
Redis:set(Thealhlfy.."Status:aktbas"..msg.chat_id,true) 
...
Redis:set(Thealhlfy..'Status:Reply'..msg.chat_id,true)
Redis:del(Thealhlfy.."Status:aktbas"..msg.chat_id) 
send(msg.chat_id,msg.id,"⇜ ابشر عطلت الاقتباسات ","md",true)
end

if Redis:get(Thealhlfy..'Status:aktbas'..msg.chat_id) == 'true' then
...
if Redis:get(Thealhlfy..'Status:aktbasrdstic'..msg.chat_id) then
return bot.sendSticker(msg.chat_id, 0, Redis:get(Thealhlfy..'Status:aktbasrdstic'..msg.chat_id))
elseif Redis:get(Thealhlfy..'Status:aktbasrdtext'..msg.chat_id) then
return send(msg.chat_id,0,Redis:get(Thealhlfy..'Status:aktbasrdtext'..msg.chat_id),"md",true)
elseif Redis:get(Thealhlfy..'Status:aktbasrdaudio'..msg.chat_id) then
return bot.sendAudio(msg.chat_id, 0, Redis:get(Thealhlfy..'Status:aktbasrdaudio'..msg.chat_id), '', "md") 
elseif Redis:get(Thealhlfy..'Status:aktbasrdanim'..msg.chat_id) then
return bot.sendAnimation(msg.chat_id,0, Redis:get(Thealhlfy..'Status:aktbasrdanim'..msg.chat_id), '', 'md')
elseif Redis:get(Thealhlfy..'Status:aktbasrdphoto'..msg.chat_id) then
return bot.sendPhoto(msg.chat_id, 0, Redis:get(Thealhlfy..'Status:aktbasrdphoto'..msg.chat_id),'')
elseif Redis:get(Thealhlfy..'Status:aktbasrdvid'..msg.chat_id) then
return bot.sendVideo(msg.chat_id, 0, Redis:get(Thealhlfy..'Status:aktbasrdvid'..msg.chat_id), '', "md")
else
...
Redis:set(Thealhlfy.."alhlfy:Game:Smile"..msg.chat_id,SM)
...
KlamSpeed = {"سحور","سياره","استقبال","قنفه","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","كهوه","سفينه","العراق","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","بتيته","لهانه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنيت","ساحه","جسر"};
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(Thealhlfy.."alhlfy:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(Thealhlfy.."alhlfy:Game:Riddles"..msg.chat_id,name)
...
if Redis:get(Thealhlfy.."alhlfy:Status:Games"..msg.chat_id) then
Redis:del(Thealhlfy.."alhlfy:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(Thealhlfy.."alhlfy:Game:Meaningof"..msg.chat_id,name)
...
if Redis:get(Thealhlfy.."alhlfy:Status:Games"..msg.chat_id) then
Redis:del(Thealhlfy.."alhlfy:Set:Aks"..msg.chat_id)
...
name = katu[math.random(#katu)]
Redis:set(Thealhlfy.."alhlfy:Game:Reflection"..msg.chat_id,name)
...
Redis:set(Thealhlfy.."alhlfy:Game:Estimate"..msg.chat_id..msg.sender_id.user_id,Num)  
...
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'النيل') 
elseif SENDTEXT:find('14') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'14') 
elseif SENDTEXT:find('الفم') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'الفم') 
elseif SENDTEXT:find('11') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'11') 
elseif SENDTEXT:find('30') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'30') 
elseif SENDTEXT:find('بوتين') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'بوتين') 
elseif SENDTEXT:find('ستيف جوبر') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'ستيف جوبر') 
elseif SENDTEXT:find('باريس') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'باريس') 
elseif SENDTEXT:find('10') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'10') 
elseif SENDTEXT:find('النمل') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'النمل') 
elseif SENDTEXT:find('حرف الواو') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'حرف الواو') 
elseif SENDTEXT:find('الشعر') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'الشعر') 
elseif SENDTEXT:find('ابراهيم') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'ابراهيم') 
elseif SENDTEXT:find('سحاب') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'سحاب') 
elseif SENDTEXT:find('الاسم') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'الاسم') 
elseif SENDTEXT:find('ذهب') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'ذهب') 
elseif SENDTEXT:find('حرف الام') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'حرف الام') 
elseif SENDTEXT:find('العزائم') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'العزائم') 
elseif SENDTEXT:find('انسات') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'انسات') 
elseif SENDTEXT:find('المنجنيق') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'المنجنيق') 
elseif SENDTEXT:find('اسيا') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'اسيا') 
elseif SENDTEXT:find('الاسد') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'الاسد') 
elseif SENDTEXT:find('6') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'6') 
elseif SENDTEXT:find('مهر') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'مهر') 
elseif SENDTEXT:find('الدلفين') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'الدلفين') 
elseif SENDTEXT:find('اوروبا') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'اوروبا') 
elseif SENDTEXT:find('الزئبق') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'الزئبق') 
elseif SENDTEXT:find('لندن') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'لندن') 
elseif SENDTEXT:find('الانسان') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'الانسان') 
elseif SENDTEXT:find('طوكيو') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'طوكيو') 
elseif SENDTEXT:find('خديجه') then
Redis:set(Thealhlfy.."GAME:CHER"..msg.chat_id,'خديجه') 
end
send(msg.chat_id,msg.id,SENDTEXT)
return false  
end
end
if Redis:get(Thealhlfy.."GAME:CHER"..msg.chat_id) and (text == Redis:get(Thealhlfy.."GAME:CHER"..msg.chat_id)) then  
if text then
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)
Redis:del(Thealhlfy.."GAME:CHER"..msg.chat_id)
local Num = Redis:get(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true)
...
print(name)
Redis:set(Thealhlfy..'bot:bkbk6'..msg.chat_id,name)
...
Redis:set(Thealhlfy..'bot:bkbk7'..msg.chat_id,name)
...
if Redis:get(Thealhlfy.."alhlfy:Status:Games"..msg.chat_id) then
Redis:del(Thealhlfy..":Number_Add:"..msg.chat_id..msg.sender_id.user_id) 
Redis:del(Thealhlfy..':List_Rolet:'..msg.chat_id)  
Redis:setex(Thealhlfy..":Start_Rolet:"..msg.chat_id..msg.sender_id.user_id,3600,true)  
return send(msg_chat_id,msg_id, '⇜ حسناً لنلعب , ارسل عدد اللاعبين للروليت .',"md")
end
end
if text == 'نعم' and Redis:get(Thealhlfy..":Witting_StartGame:"..msg.chat_id..msg.sender_id.user_id) then
local list = Redis:smembers(Thealhlfy..':List_Rolet:'..msg.chat_id) 
if #list == 1 then 
...
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 5)  
Redis:del(Thealhlfy..':List_Rolet:'..msg.chat_id) 
Redis:del(Thealhlfy..":Witting_StartGame:"..msg.chat_id..msg.sender_id.user_id)
...
if text and text:match("^(%d+)$") and Redis:get(Thealhlfy..":Start_Rolet:"..msg.chat_id..msg.sender_id.user_id) then
if text == "1" then
Text = "⇜ لا استطيع بدء اللعبة بلاعب واحد فقط\n"
else
Redis:set(Thealhlfy..":Number_Add:"..msg.chat_id..msg.sender_id.user_id,text)  
Text = '⇜ يرجى ارسال يوزرات اللاعبين \n⇜ الفائز يحصل على ( 5 ) نقاط\n⇜ عدد الاعبين المطلوبين ( '..text..' ) لاعب \n ✧'
end
Redis:del(Thealhlfy..":Start_Rolet:"..msg.chat_id..msg.sender_id.user_id)  
return send(msg_chat_id,msg_id,Text)    
end
if text and text:match('^(@[%a%d_]+)$') and Redis:get(Thealhlfy..":Number_Add:"..msg.chat_id..msg.sender_id.user_id) then    --// استقبال الاسماء
if Redis:sismember(Thealhlfy..':List_Rolet:'..msg.chat_id,text) then
return send(msg_chat_id,msg_id,'⇜  اليوزر ['..text..'] موجود قبل' ,"md")
end
Redis:sadd(Thealhlfy..':List_Rolet:'..msg.chat_id,text)
local CountAdd = Redis:get(Thealhlfy..":Number_Add:"..msg.chat_id..msg.sender_id.user_id)
local CountAll = Redis:scard(Thealhlfy..':List_Rolet:'..msg.chat_id)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
Redis:del(Thealhlfy..":Number_Add:"..msg.chat_id..msg.sender_id.user_id) 
Redis:setex(Thealhlfy..":Witting_StartGame:"..msg.chat_id..msg.sender_id.user_id,1400,true)  
...
if text == ''..(Redis:get(Thealhlfy..'bot:bkbk6'..msg.chat_id) or 'لفاتع')..'' then
Redis:del(Thealhlfy..'bot:bkbk6'..msg.chat_id)  
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)
local Num = Redis:get(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end 
if text == ''..(Redis:get(Thealhlfy..'bot:bkbk7'..msg.chat_id) or 'لفاتع')..'' then
Redis:del(Thealhlfy..'bot:bkbk7'..msg.chat_id)  
Redis:incrby(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id, 1)
local Num = Redis:get(Thealhlfy.."alhlfy:Num:Add:Games"..msg.chat_id..msg.sender_id.user_id) or 0
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك نقطة\n⇜ نقاطك الان : "..Num.." \n✧","md",true) 
end
...
Redis:set(Thealhlfy.."alhlfy:Game:Example"..msg.chat_id,name)
